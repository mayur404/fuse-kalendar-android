...
// /usr/local/share/uno/Packages/Android/0.27.4/$.uno#3
// ----------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/$.uno#2
// ----------------------------------------------------
...
void NativeActivityHelper::Init()
{
    ...
    jclass cls = ::g::Android::Base::JNI::LoadClass(jni, "com.littleboat.kalendar.kal");
...
{
    INIT_JNI;
    char const* clsName = uAllocCStr(typeName_);
    return U_JNIVAR->NewObjectArray(length_, LOAD_SYS_CLASS(clsName), NULL);
    uFreeCStr(clsName);
}
// }

// /usr/local/share/uno/Packages/Android/0.27.4/$.uno
// --------------------------------------------------
