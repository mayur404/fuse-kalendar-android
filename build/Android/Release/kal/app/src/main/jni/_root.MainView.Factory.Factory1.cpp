...
// public partial sealed class MainView.Factory.Factory1 :10
// {
// static Factory1() :17
static void MainView__Factory__Factory1__cctor__fn(uType* __type)
{
}

::g::Uno::UX::Factory_type* MainView__Factory__Factory1_typeof()
{
    ...
    options.ObjectSize = sizeof(MainView__Factory__Factory1);
    options.TypeSize = sizeof(::g::Uno::UX::Factory_type);
    type = (::g::Uno::UX::Factory_type*)uClassType::New("MainView.Factory.Factory1", options);
    type->SetBase(::g::Uno::UX::Factory_typeof());
    type->fp_cctor_ = MainView__Factory__Factory1__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Factory*, uObject**))MainView__Factory__Factory1__New1_fn;
    ::STRINGS[0] = uString::Const("TV");
    ...
    type->SetFields(2,
        ::g::MainView__Factory_typeof(), offsetof(::g::MainView__Factory__Factory1, __parent1), 0);
    return type;
}

// public Factory1(MainView.Factory parent) :13
void MainView__Factory__Factory1__ctor_1_fn(MainView__Factory__Factory1* __this, ::g::MainView__Factory* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :20
void MainView__Factory__Factory1__New1_fn(MainView__Factory__Factory1* __this, uObject** __retval)
{
...
// public Factory1 New(MainView.Factory parent) :13
void MainView__Factory__Factory1__New2_fn(::g::MainView__Factory* parent, MainView__Factory__Factory1** __retval)
{
    *__retval = MainView__Factory__Factory1::New2(parent);
}

// public Factory1(MainView.Factory parent) [instance] :13
void MainView__Factory__Factory1::ctor_1(::g::MainView__Factory* parent)
{
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Factory1 New(MainView.Factory parent) [static] :13
MainView__Factory__Factory1* MainView__Factory__Factory1::New2(::g::MainView__Factory* parent)
{
    MainView__Factory__Factory1* obj1 = (MainView__Factory__Factory1*)uNew(MainView__Factory__Factory1_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
