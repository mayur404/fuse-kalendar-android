...
static uType* TYPES[89];

namespace g{
namespace Fuse{
namespace Animations{

// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#21
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#2
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#3
// -------------------------------------------------------------
...
::g::Fuse::Animations::Animator_type* Change_typeof()
{
    ...
    ::TYPES[30] = ::g::Uno::UX::Size_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::ConverterSize_typeof();
    ::TYPES[32] = ::g::Uno::UX::Size2_typeof();
    ::TYPES[33] = ::g::Fuse::Animations::ConverterSize2_typeof();
    ::TYPES[34] = ::g::Fuse::Animations::Converter_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[0] = ::g::Fuse::Animations::Mixer_typeof();
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[37] = ::g::Fuse::Animations::ContinuousTrackChangeState_typeof();
    ::TYPES[38] = ::g::Fuse::Animations::DiscreteTrackChangeState_typeof();
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    type->SetPrecalc(
        ::TYPES[34/*Fuse.Animations.Converter`1*/]->MakeType(type->T(0)),
        ::TYPES[37/*Fuse.Animations.ContinuousTrackChangeState`1*/]->MakeType(type->T(0)),
        ::TYPES[38/*Fuse.Animations.DiscreteTrackChangeState`1*/]->MakeType(type->T(0)));
    type->SetFields(17,
...
void Change::ctor_2(::g::Uno::UX::Property* target)
{
    ...
    if (IsContinuous())
    {
        ...
        else if (::g::Uno::Type::op_Equality(__types[0], ::TYPES[30/*Uno.UX.Size*/]))
            v = ::g::Fuse::Animations::ConverterSize::Singleton();
        else if (::g::Uno::Type::op_Equality(__types[0], ::TYPES[32/*Uno.UX.Size2*/]))
...
bool Change::IsContinuous()
{
    ...
    return (((((::g::Uno::Type::op_Equality(__types[0], ::TYPES[21/*float*/]) || ::g::Uno::Type::op_Equality(__types[0], ::TYPES[23/*float2*/])) || ::g::Uno::Type::op_Equality(__types[0], ::TYPES[25/*float3*/])) || ::g::Uno::Type::op_Equality(__types[0], ::TYPES[27/*float4*/])) || ::g::Uno::Type::op_Equality(__types[0], ::TYPES[4/*double*/])) || ::g::Uno::Type::op_Equality(__types[0], ::TYPES[30/*Uno.UX.Size*/])) || ::g::Uno::Type::op_Equality(__types[0], ::TYPES[32/*Uno.UX.Size2*/]);
}
...
::g::Fuse::Animations::TrackAnimatorState_type* ContinuousTrackChangeState_typeof()
{
    ...
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[40] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[41] = ::g::Fuse::Animations::Change_typeof();
    type->SetPrecalc(
        ::TYPES[40/*Fuse.Animations.IMixer*/]->MakeMethod(1, type->T(0)),
        ::TYPES[41/*Fuse.Animations.Change`1*/]->MakeType(type->T(0)));
    type->SetFields(6,
...
void ContinuousTrackChangeState__Disable_fn(ContinuousTrackChangeState* __this)
{
    ...
    ::g::Fuse::Animations::IMixerHandle::Unregister(uInterface(uPtr(__this->mixHandle), ::TYPES[57/*Fuse.Animations.IMixerHandle`1*/]->MakeType(__this->__type->T(0))));
...
void ContinuousTrackChangeState__SeekValue_fn(ContinuousTrackChangeState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    ::g::Fuse::Animations::IMixerHandle::Set_ex(uInterface(uPtr(__this->mixHandle), ::TYPES[57/*Fuse.Animations.IMixerHandle`1*/]->MakeType(__types[0])), (uPtr((::g::Fuse::Animations::Converter*)uPtr(__this->Animator1)->ContinuousConverter)->Out_ex(uCRef(value_), &ret2), ret2), uCRef(strength_));
}
...
void ContinuousTrackChangeState::ctor_2(::g::Fuse::Animations::Change* animator, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    Animator1 = animator;
    mixHandle = ((uObject*)::g::Fuse::Animations::IMixer::Register(uInterface(uPtr(uPtr(Animator1)->Mixer), ::TYPES[40/*Fuse.Animations.IMixer*/]), __types[0], (::g::Uno::UX::Property*)uPtr(Animator1)->Target(), uPtr(Animator1)->MixOp()));
}
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#19
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#4
// -------------------------------------------------------------
...
::g::Fuse::Animations::Animator_type* Cycle_typeof()
{
    ...
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[42] = ::g::Fuse::Animations::CycleState_typeof();
    ::TYPES[43] = ::g::Uno::Delegate_typeof();
    ::TYPES[21] = ::g::Uno::Float_typeof();
    ::TYPES[4] = ::g::Uno::Double_typeof();
    type->SetPrecalc(
        ::TYPES[42/*Fuse.Animations.CycleState`1*/]->MakeType(type->T(0)));
    type->SetFields(5,
...
::g::Fuse::Animations::OpenAnimatorState_type* CycleState_typeof()
{
    ...
    ::TYPES[44] = ::g::Fuse::Animations::OpenAnimator_typeof();
    ::TYPES[40] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[45] = ::g::Fuse::Animations::Cycle_typeof();
    ::TYPES[2] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[4] = ::g::Uno::Double_typeof();
    ::TYPES[43] = ::g::Uno::Delegate_typeof();
    ::TYPES[46] = ::g::Fuse::Animations::EasingFunction_typeof();
    ::TYPES[21] = ::g::Uno::Float_typeof();
    type->SetPrecalc(
        ::TYPES[40/*Fuse.Animations.IMixer*/]->MakeMethod(1, type->T(0)),
        ::TYPES[45/*Fuse.Animations.Cycle`1*/]->MakeType(type->T(0)),
        ::TYPES[2/*Fuse.Internal.BlenderMap*/]->MakeMethod(1, type->T(0)));
    type->SetFields(5,
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#6
// -------------------------------------------------------------
...
::g::Fuse::Animations::MixerBase_type* DiscreteMixer_typeof()
{
    ...
    type->interface0.fp_RegisterTransform = (void(*)(uObject*, ::g::Fuse::Node*, int*, int*, uObject**))::g::Fuse::Animations::MixerBase__RegisterTransform_fn;
    ::TYPES[3] = ::g::Fuse::Animations::MasterProperty_typeof();
    ::TYPES[47] = ::g::Fuse::Animations::DiscreteMasterProperty_typeof();
    ::TYPES[13] = ::g::Fuse::Animations::MasterBase_typeof()->MakeType(::g::Fuse::Transform_typeof());
    type->SetInterfaces(
        ::g::Fuse::Animations::IMixer_typeof(), offsetof(::g::Fuse::Animations::MixerBase_type, interface0));
    type->SetFields(2);
...
void DiscreteMixer__CreateMaster_fn(DiscreteMixer* __this, uType* __type, ::g::Uno::UX::Property* property, ::g::Fuse::Animations::MixerBase* mixerBase, ::g::Fuse::Animations::MasterProperty** __retval)
{
    ...
    uType* __types[] = {
        ::TYPES[3/*Fuse.Animations.MasterProperty`1*/]->MakeType(__type->U(0)),
        __type->U(0),
        ::TYPES[47/*Fuse.Animations.DiscreteMasterProperty`1*/]->MakeType(__type->U(0)),
    };
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#7
// -------------------------------------------------------------
...
DiscreteSingleTrack_type* DiscreteSingleTrack_typeof()
{
    ...
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[48] = ::g::Fuse::Animations::TrackAnimatorState_typeof();
    ::TYPES[49] = ::g::Fuse::Animations::SeekResult_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[21] = ::g::Uno::Float_typeof();
    ::TYPES[4] = ::g::Uno::Double_typeof();
    type->SetInterfaces(
...
void DiscreteTrackChangeState__SeekObjectValue_fn(DiscreteTrackChangeState* __this, uObject* value, float* strength)
{
    ...
    if ((value != NULL) && uIs(value, __types[0]))
        ::g::Fuse::Animations::IMixerHandle::Set_ex(uInterface(uPtr(__this->mixHandle), ::TYPES[57/*Fuse.Animations.IMixerHandle`1*/]->MakeType(__types[0])), uUnboxAny(__types[0], value), uCRef(strength_));
}
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#8
// -------------------------------------------------------------
...
uDelegate* EasingFunctions::FromEasing(int e)
{
    ...
    {
        case 0:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__Linear_fn);
        case 1:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuadraticIn_fn);
        case 2:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuadraticOut_fn);
        case 3:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuadraticInOut_fn);
        case 4:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__CubicIn_fn);
        case 5:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__CubicOut_fn);
        case 6:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__CubicInOut_fn);
        case 7:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuarticIn_fn);
        case 8:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuarticOut_fn);
        case 9:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuarticInOut_fn);
        case 10:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuinticIn_fn);
        case 11:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuinticOut_fn);
        case 12:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__QuinticInOut_fn);
        case 13:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__SinusoidalIn_fn);
        case 14:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__SinusoidalOut_fn);
        case 15:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__SinusoidalInOut_fn);
        case 16:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__ExponentialIn_fn);
        case 17:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__ExponentialOut_fn);
        case 18:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__ExponentialInOut_fn);
        case 19:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__CircularIn_fn);
        case 20:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__CircularOut_fn);
        case 21:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__CircularInOut_fn);
        case 22:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__ElasticIn_fn);
        case 23:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__ElasticOut_fn);
        case 24:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__ElasticInOut_fn);
        case 25:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__BackIn_fn);
        case 26:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__BackOut_fn);
        case 27:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__BackInOut_fn);
        case 28:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__BounceIn_fn);
        case 29:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__BounceOut_fn);
        case 30:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__BounceInOut_fn);
        default:
            return uDelegate::New(::TYPES[46/*Fuse.Animations.EasingFunction*/], (void*)EasingFunctions__Linear_fn);
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#9
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#11
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#16
// --------------------------------------------------------------
...
MasterBase_type* MasterBase_typeof()
{
    ...
    ::TYPES[6] = ::g::Uno::Collections::List_typeof();
    ::TYPES[7] = ::g::Fuse::Animations::MixerHandle_typeof();
    ::TYPES[51] = ::g::Fuse::Animations::IMixerMaster_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
...
void MasterTransform__OnActive_fn(MasterTransform* __this)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__this->Node)->Transforms()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[52/*Fuse.Transform*/])), __this->FMT);
}
...
{
    bool ret1;
    ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(__this->Node)->Transforms()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[52/*Fuse.Transform*/])), __this->FMT, &ret1);
    __this->FMT = NULL;
}
...
static void Mixer__cctor__fn(uType* __type)
{
    ...
    Mixer::PreMasters_ = ((::g::Uno::Collections::ConcurrentCollection*)::g::Uno::Collections::ConcurrentCollection::New1(::TYPES[54/*Uno.Collections.ConcurrentCollection<Fuse.Animations.IMixerMaster>*/]));
    Mixer::PostMasters_ = ((::g::Uno::Collections::ConcurrentCollection*)::g::Uno::Collections::ConcurrentCollection::New1(::TYPES[54/*Uno.Collections.ConcurrentCollection<Fuse.Animations.IMixerMaster>*/]));
}
...
uType* Mixer_typeof()
{
    ...
    ::TYPES[40] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[54] = ::g::Uno::Collections::ConcurrentCollection_typeof()->MakeType(::g::Fuse::Animations::IMixerMaster_typeof());
...
void Mixer::AddMaster(uObject* master, bool postLayout)
{
    ...
    uDelegate* act = postLayout ? uDelegate::New(::TYPES[55/*Uno.Action*/], (void*)Mixer__CompletePost_fn) : uDelegate::New(::TYPES[55/*Uno.Action*/], (void*)Mixer__CompletePre_fn);
...
void Mixer::CompletePost()
{
...

    {
        ...
        for (int i = 0; i < c; ++i)
            ::g::Fuse::Animations::IMixerMaster::Complete(uInterface(uPtr((::g::Uno::Collections::ConcurrentCollection__get_Item_fn(uPtr(Mixer::PostMasters()), uCRef<int>(i), &ret2), ret2)), ::TYPES[51/*Fuse.Animations.IMixerMaster*/]));
    }
}
...
void Mixer::CompletePre()
{
...

    {
        ...
        for (int i = 0; i < c; ++i)
            ::g::Fuse::Animations::IMixerMaster::Complete(uInterface(uPtr((::g::Uno::Collections::ConcurrentCollection__get_Item_fn(uPtr(Mixer::PreMasters()), uCRef<int>(i), &ret3), ret3)), ::TYPES[51/*Fuse.Animations.IMixerMaster*/]));
    }
}
...
MixerBase_type* MixerBase_typeof()
{
    ...
    ::TYPES[56] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), uObject_typeof());
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[11] = uObject_typeof();
    ::TYPES[8] = ::g::Fuse::Animations::MasterBase_typeof();
    ::TYPES[57] = ::g::Fuse::Animations::IMixerHandle_typeof();
    ::TYPES[7] = ::g::Fuse::Animations::MixerHandle_typeof();
    ::TYPES[53] = ::g::Fuse::Node_typeof();
    ::TYPES[13] = ::g::Fuse::Animations::MasterBase_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[58] = ::g::Fuse::Animations::IMixerHandle_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[14] = ::g::Fuse::Animations::MixerHandle_typeof()->MakeType(::g::Fuse::Transform_typeof());
...
uObject* MixerBase::Register(uType* __type, ::g::Uno::UX::Property* property, int mode)
{
    uType* __types[] = {
        ...
        ::TYPES[57/*Fuse.Animations.IMixerHandle`1*/]->MakeType(__type->U(0)),
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#20
// --------------------------------------------------------------
...
::g::Fuse::Animations::TransformAnimator_type* Move_typeof()
{
    ...
    ::TYPES[60] = ::g::Fuse::TranslationModes_typeof();
    ::TYPES[61] = ::g::Fuse::Animations::TransformAnimator_typeof()->MakeType(::g::Fuse::Translation_typeof());
    ::TYPES[62] = ::g::Fuse::Translation_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    type->SetFields(20,
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#12
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#13
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#14
// --------------------------------------------------------------
...
uType* Player_typeof()
{
    ...
    ::TYPES[63] = ::g::Fuse::Animations::PlayerPart_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[43] = ::g::Uno::Delegate_typeof();
    ::TYPES[64] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof());
    ::TYPES[11] = uObject_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[65] = ::g::Fuse::Animations::AnimatorState_typeof()->Array();
    ::TYPES[55] = ::g::Uno::Action_typeof();
    ::TYPES[66] = ::g::Fuse::Time_typeof();
    ::TYPES[4] = ::g::Uno::Double_typeof();
    type->SetFields(0,
...
void Player::Start()
{
    ...
    {
        _isStarted = true;
        ::g::Fuse::UpdateManager::AddAction(uDelegate::New(::TYPES[55/*Uno.Action*/], (void*)Player__CheckUpdateAction_fn, this), 0);
    }
}
...
void Player::Stop()
{
    ...
    {
        _isStarted = false;
        ::g::Fuse::UpdateManager::RemoveAction(uDelegate::New(::TYPES[55/*Uno.Action*/], (void*)Player__CheckUpdateAction_fn, this), 0);
...
::g::Fuse::Animations::TrackAnimatorState_type* ResizeAnimatorState_typeof()
{
    ...
    ::STRINGS[2] = uString::Const("Resize started without a Target node");
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#16");
    ::STRINGS[4] = uString::Const(".ctor");
    ::STRINGS[5] = uString::Const("Resize started without as RelativeTo");
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[67] = ::g::Fuse::Animations::Resize_typeof();
    ::TYPES[68] = ::g::Fuse::Animations::IResize_typeof();
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[11] = uObject_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[69] = ::g::Fuse::ITransformMode_typeof();
    ::TYPES[70] = ::g::Fuse::IActualPlacement_typeof();
...
void ResizeAnimatorState__Disable_fn(ResizeAnimatorState* __this)
{
    ...
    uObject* e = uAs<uObject*>(__this->_target, ::TYPES[70/*Fuse.IActualPlacement*/]);

    if (e != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(e), ::TYPES[70/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[71/*Fuse.PlacedHandler*/], (void*)ResizeAnimatorState__OnPlaced_fn, __this));

    if ((::g::Fuse::ITransformMode::Flags(uInterface(uPtr(__this->_relativeTo), ::TYPES[69/*Fuse.ITransformMode*/])) & 1) == 1)
    {
        uObject* elm = uAs<uObject*>(__this->_relativeNode, ::TYPES[70/*Fuse.IActualPlacement*/]);

        if (elm != NULL)
            ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(elm), ::TYPES[70/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[71/*Fuse.PlacedHandler*/], (void*)ResizeAnimatorState__OnPlaced_fn, __this));
    }
}
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    _resize = r;
    _target = uAs<uObject*>(Node, ::TYPES[68/*Fuse.Animations.IResize*/]);

    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::Error(::STRINGS[2/*"Resize star...*/], r, ::STRINGS[3/*"/usr/local/...*/], 2683, ::STRINGS[4/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::Error(::STRINGS[5/*"Resize star...*/], r, ::STRINGS[3/*"/usr/local/...*/], 2691, ::STRINGS[4/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if ((::g::Fuse::ITransformMode::Flags(uInterface(uPtr(_relativeTo), ::TYPES[69/*Fuse.ITransformMode*/])) & 1) == 1)
    {
        uObject* elm = uAs<uObject*>(_relativeNode, ::TYPES[70/*Fuse.IActualPlacement*/]);

        if (elm != NULL)
            ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(elm), ::TYPES[70/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[71/*Fuse.PlacedHandler*/], (void*)ResizeAnimatorState__OnPlaced_fn, this));
    }

    uObject* e = uAs<uObject*>(_target, ::TYPES[70/*Fuse.IActualPlacement*/]);

    if (e != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(e), ::TYPES[70/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[71/*Fuse.PlacedHandler*/], (void*)ResizeAnimatorState__OnPlaced_fn, this));
}
...
void ResizeAnimatorState::Update(::g::Uno::Float4 value, float strength)
{
    ...
    if (::g::Fuse::Animations::IResizeMode::GetSizeChange(uInterface(uPtr(_relativeTo), ::g::Fuse::Animations::IResizeMode_typeof()), Node, _relativeNode, &baseSize, &deltaSize))
    {
        ...
        ::g::Fuse::Animations::IResize::SetSize(uInterface(uPtr(_target), ::TYPES[68/*Fuse.Animations.IResize*/]), sz);
    }
}
...
::g::Fuse::Animations::TransformAnimator_type* Rotate_typeof()
{
    ...
    ::TYPES[72] = ::g::Fuse::Rotation_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    type->SetFields(20);
    return type;
}
...
::g::Fuse::Animations::TransformAnimator_type* Scale_typeof()
{
    ...
    ::TYPES[73] = ::g::Fuse::ScalingModes_typeof();
    ::TYPES[74] = ::g::Fuse::Animations::TransformAnimator_typeof()->MakeType(::g::Fuse::Scaling_typeof());
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[75] = ::g::Fuse::Scaling_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    type->SetFields(20,
...
// /usr/local/share/uno/Packages/Fuse.Animations/0.27.10/$.uno#17
// --------------------------------------------------------------
...
::g::Fuse::Animations::OpenAnimatorState_type* SpinState_typeof()
{
    ...
    ::TYPES[44] = ::g::Fuse::Animations::OpenAnimator_typeof();
    ::TYPES[77] = ::g::Fuse::Animations::Spin_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[4] = ::g::Uno::Double_typeof();
    ::TYPES[72] = ::g::Fuse::Rotation_typeof();
...
void SpinState__Disable_fn(SpinState* __this)
{
    ...
    __this->degrees = 0.0;
    ::g::Fuse::Animations::IMixerHandle::Unregister(uInterface(uPtr(__this->mixHandle), ::TYPES[58/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/]));
    __this->mixHandle = NULL;
}
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    ::g::Fuse::Animations::IMixerHandle::Set_ex(uInterface(uPtr(__this->mixHandle), ::TYPES[58/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/]), __this->transform, uCRef(strength_));
    return *__retval = done, void();
}
...
void SpinState::ctor_2(::g::Fuse::Animations::Spin* animator, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    Animator1 = animator;
    mixHandle = ::g::Fuse::Animations::IMixer::RegisterTransform(uInterface(uPtr(uPtr(Animator1)->Mixer), ::TYPES[40/*Fuse.Animations.IMixer*/]), Node, uPtr(Animator1)->MixOp(), 3000);
}
...
::g::Fuse::Animations::Animator_type* TrackAnimator_typeof()
{
    ...
    ::TYPES[78] = ::g::Fuse::Animations::TrackProvider_typeof();
    ::TYPES[79] = ::g::Fuse::Animations::EasingTrack_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[80] = ::g::Fuse::Animations::DiscreteSingleTrack_typeof();
    type->SetFields(3,
...
void TrackAnimator__get_AnimatorVariant_fn(TrackAnimator* __this, int* __retval)
{
    if (__this->_discreteProvider != NULL)
        return *__retval = ::g::Fuse::Animations::TrackProvider::GetAnimatorVariant(uInterface(uPtr(__this->_discreteProvider), ::TYPES[78/*Fuse.Animations.TrackProvider*/]), __this), void();
    else if (__this->_continuousProvider != NULL)
        return *__retval = ::g::Fuse::Animations::TrackProvider::GetAnimatorVariant(uInterface(uPtr(__this->_continuousProvider), ::TYPES[78/*Fuse.Animations.TrackProvider*/]), __this), void();
...
void TrackAnimator__GetDurationWithDelay_fn(TrackAnimator* __this, int* dir, double* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
        duration = ::g::Fuse::Animations::TrackProvider::GetDuration(uInterface(uPtr(__this->_discreteProvider), ::TYPES[78/*Fuse.Animations.TrackProvider*/]), __this, dir_);
    else if (__this->_continuousProvider != NULL)
        duration = ::g::Fuse::Animations::TrackProvider::GetDuration(uInterface(uPtr(__this->_continuousProvider), ::TYPES[78/*Fuse.Animations.TrackProvider*/]), __this, dir_);
...
TrackAnimatorState_type* TrackAnimatorState_typeof()
{
    ...
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[50] = ::g::Fuse::Animations::ContinuousTrackProvider_typeof();
    ::TYPES[81] = ::g::Fuse::Animations::DiscreteTrackProvider_typeof();
    ::TYPES[21] = ::g::Uno::Float_typeof();
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
...
void TrackAnimatorState__SeekProgress_fn(TrackAnimatorState* __this, double* progress, double* interval, int* dir, double* strength, int* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
    {
        double oStrength1;
        uObject* oValue1;
        int r1 = ::g::Fuse::Animations::DiscreteTrackProvider::GetSeekProgress(uInterface(uPtr(__this->_discreteProvider), ::TYPES[81/*Fuse.Animations.DiscreteTrackProvider*/]), __this, progress_, interval_, dir_, &oValue1, &oStrength1);
...
void TrackAnimatorState__SeekTime_fn(TrackAnimatorState* __this, double* elapsed, double* interval, int* dir, double* strength, int* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
    {
        double oStrength1;
        uObject* oValue1;
        int r1 = ::g::Fuse::Animations::DiscreteTrackProvider::GetSeekTime(uInterface(uPtr(__this->_discreteProvider), ::TYPES[81/*Fuse.Animations.DiscreteTrackProvider*/]), __this, relTime, interval_, dir_, &oValue1, &oStrength1);
...
void TrackAnimatorState::ctor_1(::g::Fuse::Animations::TrackAnimator* animator, ::g::Fuse::Animations::CreateStateParams* p, ::g::Fuse::Node* useNode)
{
    ...
    _discreteProvider = uAs<uObject*>(pr, ::TYPES[81/*Fuse.Animations.DiscreteTrackProvider*/]);
}
...
TransformAnimator_type* TransformAnimator_typeof()
{
    ...
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[82] = ::g::Fuse::Animations::TransformAnimatorState_typeof();
    ::TYPES[27] = ::g::Uno::Float4_typeof();
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    type->SetPrecalc(
        ::TYPES[82/*Fuse.Animations.TransformAnimatorState`1*/]->MakeType(type->T(0)));
    type->SetFields(17,
...
::g::Fuse::Animations::TrackAnimatorState_type* TransformAnimatorState_typeof()
{
    ...
    ::TYPES[39] = ::g::Fuse::Animations::TrackAnimator_typeof();
    ::TYPES[83] = ::g::Fuse::Animations::TransformAnimator_typeof();
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[36] = ::g::Fuse::Animations::AnimatorState_typeof();
    ::TYPES[84] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof());
    ::TYPES[52] = ::g::Fuse::Transform_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    type->SetPrecalc(
        ::TYPES[83/*Fuse.Animations.TransformAnimator`1*/]->MakeType(type->T(0)));
    type->SetFields(6,
...
void TransformAnimatorState__Disable_fn(TransformAnimatorState* __this)
{
    ...
    uPtr(uAs< ::g::Fuse::Transform*>(__this->transform, ::TYPES[52/*Fuse.Transform*/]))->Removed(__this->Node);
    __this->_matAct = NULL;
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    __this->_inSeek = true;
    uPtr(uAs< ::g::Fuse::Transform*>(__this->transform, ::TYPES[52/*Fuse.Transform*/]))->RelativeNode((ind1 = uPtr(__this->Animator1)->RelativeNode(), (ind1 != NULL) ? ind1 : (::g::Fuse::Node*)__this->Node));
    uPtr(__this->Animator1)->Update(__this->Node, __this->transform, value_);
    __this->_lastStrength = strength_;
    ::g::Fuse::Animations::IMixerHandle::Set_ex(uInterface(uPtr(__this->mixHandle), ::TYPES[58/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/]), __this->transform, uCRef(__this->_lastStrength));
...
void TransformAnimatorState::ctor_2(::g::Fuse::Animations::TransformAnimator* animator, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    ctor_1(animator, p, uPtr(animator)->Target());
    Animator1 = animator;
    mixHandle = ::g::Fuse::Animations::IMixer::RegisterTransform(uInterface(uPtr(uPtr(Animator1)->Mixer), ::TYPES[40/*Fuse.Animations.IMixer*/]), Node, uPtr(Animator1)->MixOp(), uPtr(Animator1)->Priority());
    _matAct = uDelegate::New(::TYPES[84/*Uno.Action<Fuse.Transform>*/], (void*)TransformAnimatorState__OnMatrixChanged_fn, this);
    uPtr(uAs< ::g::Fuse::Transform*>(transform, ::TYPES[52/*Fuse.Transform*/]))->add_MatrixChanged(_matAct);
    uPtr(uAs< ::g::Fuse::Transform*>(transform, ::TYPES[52/*Fuse.Transform*/]))->Added(Node);
}
...
void TransformAnimatorState::OnMatrixChanged(::g::Fuse::Transform* ignore)
{
    if ((!_inSeek && (mixHandle != NULL)) && (transform != NULL))
        ::g::Fuse::Animations::IMixerHandle::Set_ex(uInterface(uPtr(mixHandle), ::TYPES[58/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/]), transform, uCRef(_lastStrength));
}
...
uType* TriggerAnimation_typeof()
{
    ...
    ::TYPES[1] = ::g::Fuse::Animations::CreateStateParams_typeof();
    ::TYPES[65] = ::g::Fuse::Animations::AnimatorState_typeof()->Array();
    ::TYPES[85] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[43] = ::g::Uno::Delegate_typeof();
    ::TYPES[55] = ::g::Uno::Action_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[86] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    ::TYPES[35] = ::g::Fuse::Animations::Animator_typeof();
    type->SetFields(0,
...
{
    if (_animators == NULL)
        _animators = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[85/*Uno.Collections.List<Fuse.Animations.Animator>*/]));
...
uArray* TriggerAnimation::CreateAnimatorsState(int variant, ::g::Fuse::Node* elm)
{
    ...
    if (_animators == NULL)
        return uArray::New(::TYPES[65/*Fuse.Animations.AnimatorState[]*/], 0);

    uArray* state = uArray::New(::TYPES[65/*Fuse.Animations.AnimatorState[]*/], uPtr(_animators)->Count());
...
{
    TimeChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(TimeChanged1, value), ::TYPES[55/*Uno.Action*/]);
}
...
{
    TimeChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(TimeChanged1, value), ::TYPES[55/*Uno.Action*/]);
}
...
uType* TriggerAnimationState_typeof()
{
    ...
    ::TYPES[87] = ::g::Fuse::Animations::TriggerAnimation_typeof();
    ::TYPES[55] = ::g::Uno::Action_typeof();
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[10] = ::g::Uno::Int_typeof();
    ::TYPES[88] = ::g::Fuse::Animations::Player_typeof();
    ::TYPES[43] = ::g::Uno::Delegate_typeof();
    ::TYPES[64] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof());
    ::TYPES[11] = uObject_typeof();
    type->SetFields(0,
...
{
    Animation(animation);
    uPtr(Animation())->add_TimeChanged(uDelegate::New(::TYPES[55/*Uno.Action*/], (void*)TriggerAnimationState__OnTimeChanged_fn, this));
    _node = node;
}
...
::g::Fuse::Animations::Player* TriggerAnimationState::GetCurrentPlayer(int tendTo, int flags)
{
    ...
    return uAs< ::g::Fuse::Animations::Player*>(GetPlayer(tendTo, false), ::TYPES[88/*Fuse.Animations.Player*/]);
}
...
{
    PlaybackDone1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(PlaybackDone1, value), ::TYPES[64/*Uno.Action<object>*/]);
}
...
{
    PlaybackDone1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(PlaybackDone1, value), ::TYPES[64/*Uno.Action<object>*/]);
}
...
{
    ProgressUpdated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ProgressUpdated1, value), ::TYPES[64/*Uno.Action<object>*/]);
}
...
{
    ProgressUpdated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ProgressUpdated1, value), ::TYPES[64/*Uno.Action<object>*/]);
}
...
{
    uPtr(player)->ProgressUpdated = uDelegate::New(::TYPES[64/*Uno.Action<object>*/], (void*)TriggerAnimationState__OnProgressUpdated_fn, this);
    player->DoneCallback(uDelegate::New(::TYPES[64/*Uno.Action<object>*/], (void*)TriggerAnimationState__OnPlaybackDone_fn, this));
}
