...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/littleboat/kalendar/kal");
    jclass entryPointsClass = env->FindClass("com/littleboat/kalendar/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/littleboat/kalendar/Display");
