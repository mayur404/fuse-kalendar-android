...
#include <_root.MainView.Factory2.Factory3.h>
#include <_root.MainView.Factory2.Factory4.h>
...
// {
// static Factory2() :441
static void MainView__Factory2__cctor__fn(uType* __type)
{
}
...
::g::Uno::UX::Factory_type* MainView__Factory2_typeof()
{
    ...
    options.ObjectSize = sizeof(MainView__Factory2);
    options.TypeSize = sizeof(::g::Uno::UX::Factory_type);
    type = (::g::Uno::UX::Factory_type*)uClassType::New("MainView.Factory2", options);
    type->SetBase(::g::Uno::UX::Factory_typeof());
    type->fp_cctor_ = MainView__Factory2__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Factory*, uObject**))MainView__Factory2__New1_fn;
    ::STRINGS[0] = uString::Const("name");
    ::STRINGS[1] = uString::Const("date");
    ::STRINGS[2] = uString::Const("status");
    ::STRINGS[3] = uString::Const("movieListHandler");
    ::STRINGS[4] = uString::Const("movieItem");
    ::STRINGS[5] = uString::Const("PAST");
    ::STRINGS[6] = uString::Const("LATER");
    ::STRINGS[7] = uString::Const("SOON");
    ...
    type->SetFields(2,
        ::g::MainView_typeof(), offsetof(::g::MainView__Factory2, __parent1), 0,
        ::g::kal_FuseControlsPanel_Background_Property_typeof(), offsetof(::g::MainView__Factory2, self_Background_inst), 0,
        ::g::kal_FuseTriggersStateGroup_Active_Property_typeof(), offsetof(::g::MainView__Factory2, stateGroupMovie_Active_inst), 0,
        ::g::kal_FuseControlsText_Value_Property_typeof(), offsetof(::g::MainView__Factory2, temp_Value_inst), 0,
        ::g::kal_FuseControlsText_Value_Property_typeof(), offsetof(::g::MainView__Factory2, temp1_Value_inst), 0,
        ::g::kal_FuseReactiveMatch_Value_Property_typeof(), offsetof(::g::MainView__Factory2, temp2_Value_inst), 0);
    return type;
}

// public Factory2(MainView parent) :323
void MainView__Factory2__ctor_1_fn(MainView__Factory2* __this, ::g::MainView* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :444
void MainView__Factory2__New1_fn(MainView__Factory2* __this, uObject** __retval)
{
    ...
    __this->stateGroupMovie_Active_inst = ::g::kal_FuseTriggersStateGroup_Active_Property::New1(uPtr(__this->__parent1)->stateGroupMovie);
    ...
    ::g::Fuse::Reactive::DataBinding* temp4 = (::g::Fuse::Reactive::DataBinding*)::g::Fuse::Reactive::DataBinding::New1(::TYPES[1/*Fuse.Reactive.DataBinding<string>*/], __this->temp1_Value_inst, ::STRINGS[1/*"date"*/]);
    ::g::Fuse::Reactive::Case* temp5 = ::g::Fuse::Reactive::Case::New1();
    MainView__Factory2__Factory3* temp6 = MainView__Factory2__Factory3::New2(__this);
    ::g::Fuse::Reactive::Case* temp7 = ::g::Fuse::Reactive::Case::New1();
    MainView__Factory2__Factory4* temp8 = MainView__Factory2__Factory4::New2(__this);
    ::g::Fuse::Reactive::Case* temp9 = ::g::Fuse::Reactive::Case::New1();
    MainView__Factory2__Factory5* temp10 = MainView__Factory2__Factory5::New2(__this);
    ...
    ::g::Fuse::Triggers::Actions::Set* temp18 = (::g::Fuse::Triggers::Actions::Set*)::g::Fuse::Triggers::Actions::Set::New1(::TYPES[5/*Fuse.Triggers.Actions.Set<Fuse.Triggers.State>*/], __this->stateGroupMovie_Active_inst);
    ...
    ::g::Fuse::Reactive::EventBinding* temp_eb01 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[3/*"movieListHa...*/]);
    ...
    temp17->add_Handler(uDelegate::New(::TYPES[22/*Fuse.NodeEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, temp_eb01));
    ::g::Fuse::Triggers::Actions::Set__set_Value_fn(temp18, uPtr(__this->__parent1)->movieL2);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(self->Behaviors()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[12/*Fuse.Behavior*/])), temp_eb01);
...
// public Factory2 New(MainView parent) :323
void MainView__Factory2__New2_fn(::g::MainView* parent, MainView__Factory2** __retval)
{
    *__retval = MainView__Factory2::New2(parent);
}

// public Factory2(MainView parent) [instance] :323
void MainView__Factory2::ctor_1(::g::MainView* parent)
{
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Factory2 New(MainView parent) [static] :323
MainView__Factory2* MainView__Factory2::New2(::g::MainView* parent)
{
    MainView__Factory2* obj1 = (MainView__Factory2*)uNew(MainView__Factory2_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
