...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/UriParsers/$.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#2
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/UriParsers/$.uno#1
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/UriParsers/$.uno#2
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#6
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#1
// ----------------------------------------------------------
...
HttpMessageHandlerRequest_type* HttpMessageHandlerRequest_typeof()
{
    ...
    ::STRINGS[27] = uString::Const("HttpMessageHandlerRequest");
    ::STRINGS[28] = uString::Const("");
    ::STRINGS[29] = uString::Const("GET");
    ::STRINGS[30] = uString::Const("HEAD");
    ::STRINGS[31] = uString::Const("Not allowed to set header \"");
    ::STRINGS[32] = uString::Const("\" on this target.");
...
// public void EnableCache(bool enableCache) :457
...
// private void FireSetHeadersReceived() :445
...
void HttpMessageHandlerRequest::CheckDisposed()
{
    if (_httpRequest == NULL)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[27/*"HttpMessage...*/]));
}
...
// public void EnableCache(bool enableCache) [instance] :457
...
// private void FireSetHeadersReceived() [instance] :445
...
uString* HttpMessageHandlerRequest::GetResponseContentString()
{
    ...
    return (ind1 != NULL) ? ind1 : ::STRINGS[28/*""*/];
}
...
// internal void OnHeadersReceived() [instance] :441
...
// internal void OnProgress(int current, int total, bool hasTotal) [instance] :450
...
void HttpMessageHandlerRequest::SendAsync2(uString* data)
{
    ...
    if (((::g::Uno::String::op_Equality(Method(), ::STRINGS[29/*"GET"*/]) || ::g::Uno::String::op_Equality(Method(), ::STRINGS[30/*"HEAD"*/])) || ::g::Uno::String::op_Equality(data, NULL)) || ::g::Uno::String::op_Equality(data, ::STRINGS[28/*""*/]))
        ::g::Uno::Net::Http::Implementation::IHttpRequest::SendAsync(uInterface(uPtr(_httpRequest), ::TYPES[17/*Uno.Net.Http.Implementation.IHttpRequest*/]));
    else
...
void HttpMessageHandlerRequest::SetHeader(uString* name, uString* value)
{
    ...
    if (!HttpMessageHandlerRequest::IsHeaderValid(name, value))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"Not allowed...*/], name), ::STRINGS[32/*"\" on this ...*/])));
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#3
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#4
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#5
// ----------------------------------------------------------
...
static void HttpStatusReasonPhrase__cctor__fn(uType* __type)
{
    ...
    HttpStatusReasonPhrase::Informational_ = (uObject*)(collection5 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(100), ::STRINGS[33/*"Continue"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection5), uCRef<int>(101), ::STRINGS[34/*"Switching P...*/]), collection5);
    HttpStatusReasonPhrase::Success_ = (uObject*)(collection4 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(200), ::STRINGS[35/*"OK"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(201), ::STRINGS[36/*"Created"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(202), ::STRINGS[37/*"Accepted"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(203), ::STRINGS[38/*"Non-Authori...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(204), ::STRINGS[39/*"No Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(205), ::STRINGS[40/*"Reset Content"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection4), uCRef<int>(206), ::STRINGS[41/*"Partial Con...*/]), collection4);
    HttpStatusReasonPhrase::Redirection_ = (uObject*)(collection3 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(300), ::STRINGS[42/*"Multiple Ch...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(301), ::STRINGS[43/*"Moved Perma...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(302), ::STRINGS[44/*"Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(303), ::STRINGS[45/*"See Other"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(304), ::STRINGS[46/*"Not Modified"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(305), ::STRINGS[47/*"Use Proxy"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection3), uCRef<int>(307), ::STRINGS[48/*"Temporary R...*/]), collection3);
    HttpStatusReasonPhrase::ClientErrors_ = (uObject*)(collection2 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(400), ::STRINGS[49/*"Bad Request"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(401), ::STRINGS[50/*"Unauthorized"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(402), ::STRINGS[51/*"Payment Req...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(403), ::STRINGS[52/*"Forbidden"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(404), ::STRINGS[53/*"Not Found"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(405), ::STRINGS[54/*"Method Not ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(406), ::STRINGS[55/*"Not Accepta...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(407), ::STRINGS[56/*"Proxy Authe...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(408), ::STRINGS[57/*"Request Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(409), ::STRINGS[58/*"Conflict"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(410), ::STRINGS[59/*"Gone"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(411), ::STRINGS[60/*"Length Requ...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(412), ::STRINGS[61/*"Preconditio...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(413), ::STRINGS[62/*"Request Ent...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(414), ::STRINGS[63/*"Request-URI...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(415), ::STRINGS[64/*"Unsupported...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(416), ::STRINGS[65/*"Requested r...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection2), uCRef<int>(417), ::STRINGS[66/*"Expectation...*/]), collection2);
    HttpStatusReasonPhrase::ServerErrors_ = (uObject*)(collection1 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<int, string>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(500), ::STRINGS[67/*"Internal Se...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(501), ::STRINGS[68/*"Not Impleme...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(502), ::STRINGS[69/*"Bad Gateway"*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(503), ::STRINGS[70/*"Service Una...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(504), ::STRINGS[71/*"Gateway Tim...*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), uCRef<int>(505), ::STRINGS[72/*"HTTP Versio...*/]), collection1);
}
...
uClassType* HttpStatusReasonPhrase_typeof()
{
    ...
    ::STRINGS[33] = uString::Const("Continue");
    ::STRINGS[34] = uString::Const("Switching Protocols");
    ::STRINGS[35] = uString::Const("OK");
    ::STRINGS[36] = uString::Const("Created");
    ::STRINGS[37] = uString::Const("Accepted");
    ::STRINGS[38] = uString::Const("Non-Authoritative Information");
    ::STRINGS[39] = uString::Const("No Content");
    ::STRINGS[40] = uString::Const("Reset Content");
    ::STRINGS[41] = uString::Const("Partial Content");
    ::STRINGS[42] = uString::Const("Multiple Choices");
    ::STRINGS[43] = uString::Const("Moved Permanently");
    ::STRINGS[44] = uString::Const("Found");
    ::STRINGS[45] = uString::Const("See Other");
    ::STRINGS[46] = uString::Const("Not Modified");
    ::STRINGS[47] = uString::Const("Use Proxy");
    ::STRINGS[48] = uString::Const("Temporary Redirect");
    ::STRINGS[49] = uString::Const("Bad Request");
    ::STRINGS[50] = uString::Const("Unauthorized");
    ::STRINGS[51] = uString::Const("Payment Required");
    ::STRINGS[52] = uString::Const("Forbidden");
    ::STRINGS[53] = uString::Const("Not Found");
    ::STRINGS[54] = uString::Const("Method Not Allowed");
    ::STRINGS[55] = uString::Const("Not Acceptable");
    ::STRINGS[56] = uString::Const("Proxy Authentication Required");
    ::STRINGS[57] = uString::Const("Request Time-out");
    ::STRINGS[58] = uString::Const("Conflict");
    ::STRINGS[59] = uString::Const("Gone");
    ::STRINGS[60] = uString::Const("Length Required");
    ::STRINGS[61] = uString::Const("Precondition Failed");
    ::STRINGS[62] = uString::Const("Request Entity Too Large");
    ::STRINGS[63] = uString::Const("Request-URI Too Large");
    ::STRINGS[64] = uString::Const("Unsupported Media Type");
    ::STRINGS[65] = uString::Const("Requested range not satisfiable");
    ::STRINGS[66] = uString::Const("Expectation Failed");
    ::STRINGS[67] = uString::Const("Internal Server Error");
    ::STRINGS[68] = uString::Const("Not Implemented");
    ::STRINGS[69] = uString::Const("Bad Gateway");
    ::STRINGS[70] = uString::Const("Service Unavailable");
    ::STRINGS[71] = uString::Const("Gateway Time-out");
    ::STRINGS[72] = uString::Const("HTTP Version not supported");
...
::g::Uno::Exception_type* InvalidResponseTypeException_typeof()
{
    ...
    ::STRINGS[73] = uString::Const("Response type is invalid.");
    type->SetFields(3);
    return type;
}
...
::g::Uno::Exception_type* InvalidStateException_typeof()
{
    ...
    ::STRINGS[74] = uString::Const("The object is in an invalid state.");
    type->SetFields(3);
    return type;
}
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/UriParsers/$.uno#3
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/UriParsers/$.uno#4
// ---------------------------------------------------------------------
...
uType* SchemeParser_typeof()
{
    ...
    ::STRINGS[10] = uString::Const(":");
    ::STRINGS[75] = uString::Const("The scheme isn't specified in uriString.");
    ::STRINGS[76] = uString::Const("The scheme specified in uriString is not correctly formed.");
    ::STRINGS[77] = uString::Const("The length of the scheme specified in uriString exceeds 1023 characters.");
    ::STRINGS[21] = uString::Const("There is an invalid character sequence in uriString.");
    ::TYPES[3] = ::g::Uno::String_typeof();
...
::g::Uno::Net::Http::SchemeParserResult SchemeParser::Parse(uString* uriString, int* idx)
{
    ...
    if ((end - *idx) > 1023)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[77/*"The length ...*/]));
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#7
// ----------------------------------------------------------

// public sealed class Uri :867
// {
uType* Uri_typeof()
{
    static uSStrong<uType*> type;
    ...
    ::STRINGS[78] = uString::Const("uriString");
    ::STRINGS[79] = uString::Const("The length of uriString exceeds 65519 characters.");
    ::TYPES[3] = ::g::Uno::String_typeof();
    ::TYPES[28] = ::g::Uno::Net::Http::SchemeParserResult_typeof();
    ::TYPES[18] = ::g::Uno::Int_typeof();
    ::TYPES[9] = ::g::Uno::Net::Http::HostInfo_typeof();
...
// public generated string get_AbsolutePath() [instance] :869
uString* Uri::AbsolutePath()
{
    return _AbsolutePath;
}

// private generated void set_AbsolutePath(string value) [instance] :869
void Uri::AbsolutePath(uString* value)
{
    _AbsolutePath = value;
}

// public generated string get_AbsoluteUri() [instance] :871
uString* Uri::AbsoluteUri()
{
    return _AbsoluteUri;
}

// private generated void set_AbsoluteUri(string value) [instance] :871
void Uri::AbsoluteUri(uString* value)
{
    _AbsoluteUri = value;
}

// public generated string get_Authority() [instance] :873
uString* Uri::Authority()
{
    return _Authority;
}

// private generated void set_Authority(string value) [instance] :873
void Uri::Authority(uString* value)
{
    _Authority = value;
}

// private void CreateThis(string uriString) [instance] :927
...
// public generated string get_Hash() [instance] :885
uString* Uri::Hash()
{
    return _Hash;
}

// private generated void set_Hash(string value) [instance] :885
void Uri::Hash(uString* value)
{
    _Hash = value;
}

// public generated string get_Host() [instance] :875
uString* Uri::Host()
{
    return _Host;
}

// private generated void set_Host(string value) [instance] :875
void Uri::Host(uString* value)
{
    _Host = value;
}

// public generated string get_OriginalString() [instance] :877
uString* Uri::OriginalString()
{
    return _OriginalString;
}

// private generated void set_OriginalString(string value) [instance] :877
void Uri::OriginalString(uString* value)
{
    _OriginalString = value;
}

// public generated string get_PathAndQuery() [instance] :879
uString* Uri::PathAndQuery()
{
    return _PathAndQuery;
}

// private generated void set_PathAndQuery(string value) [instance] :879
void Uri::PathAndQuery(uString* value)
{
    _PathAndQuery = value;
}

// public generated int get_Port() [instance] :881
int Uri::Port()
{
    return _Port;
}

// private generated void set_Port(int value) [instance] :881
void Uri::Port(int value)
{
    _Port = value;
}

// public generated string get_Query() [instance] :883
uString* Uri::Query()
{
    return _Query;
}

// private generated void set_Query(string value) [instance] :883
void Uri::Query(uString* value)
{
    _Query = value;
}

// public generated string get_Scheme() [instance] :887
uString* Uri::Scheme()
{
    return _Scheme;
}

// private generated void set_Scheme(string value) [instance] :887
void Uri::Scheme(uString* value)
{
    _Scheme = value;
}

// public generated string get_UserInfo() [instance] :889
uString* Uri::UserInfo()
{
    return _UserInfo;
}

// private generated void set_UserInfo(string value) [instance] :889
void Uri::UserInfo(uString* value)
{
    _UserInfo = value;
}

// public Uri New(string uriString) [static] :891
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#8
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/$.uno#9
// ----------------------------------------------------------
...
static void UriScheme__cctor__fn(uType* __type)
{
    ...
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[80/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[81/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[82/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[83/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[84/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[85/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[86/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[87/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[88/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[89/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[90/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[91/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[92/*"news"*/]), collection1);
}
...
// /usr/local/share/uno/Packages/Uno.Net.Http/0.27.15/UriParsers/$.uno#5
// ---------------------------------------------------------------------
