...
// /usr/local/share/uno/Packages/Fuse.GeoLocation/0.27.10/Android/$.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.GeoLocation/0.27.10/$.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.GeoLocation/0.27.10/$.uno#2
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.GeoLocation/0.27.10/$.uno#1
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.GeoLocation/0.27.10/Android/$.uno#1
// ----------------------------------------------------------------------
...
::g::Uno::Threading::Future1* LocationTracker::GetLocationAsync(double timeout)
{
    ...
    try
    {
        if (LocationTracker::_locationTracker() != NULL)
        {
            ...
            uPtr(promise)->Reject(::g::Uno::Exception::New2(::STRINGS[9/*"Not support...*/]));
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
...
// /usr/local/share/uno/Packages/Fuse.GeoLocation/0.27.10/Android/$.uno#2
// ----------------------------------------------------------------------
