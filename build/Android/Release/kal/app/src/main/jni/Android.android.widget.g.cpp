...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#23
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#3
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#9
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#10
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#130
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#29
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#31
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#45
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#53
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#54
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#19
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#2
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#37
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#75
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#78
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#81
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#152
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#90
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#8
// ---------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#163
// -----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/android/widget/$.uno#102
// -----------------------------------------------------------------------------
...
::g::Android::java::lang::Object_type* Toast_typeof()
{
    ...
    options.TypeSize = sizeof(::g::Android::java::lang::Object_type);
    type = (::g::Android::java::lang::Object_type*)uClassType::New("Android.android.widget.Toast", options);
    type->SetBase(::g::Android::java::lang::Object_typeof());
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__UnoIDisposableDispose_fn;
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Android::java::lang::Object_type, interface1));
    type->SetFields(5,
        ::g::Android::Base::Primitives::ujclass_typeof(), (uintptr_t)&::g::Android::android::widget::Toast::_javaClass2_, uFieldFlagsStatic,
        ::g::Android::Base::Primitives::jfieldID_typeof(), (uintptr_t)&::g::Android::android::widget::Toast::LENGTH_LONG_26790_ID_, uFieldFlagsStatic,
        ::g::Android::Base::Primitives::jmethodID_typeof(), (uintptr_t)&::g::Android::android::widget::Toast::makeText_26805_ID_, uFieldFlagsStatic,
        ::g::Android::Base::Primitives::jmethodID_typeof(), (uintptr_t)&::g::Android::android::widget::Toast::show_26792_ID_, uFieldFlagsStatic);
    return type;
}

// public static extern new void _Init() :26546
void Toast___Init2_fn()
{
    Toast::_Init2();
}

// public static int get_LENGTH_LONG() :26568
void Toast__get_LENGTH_LONG_fn(int* __retval)
{
    *__retval = Toast::LENGTH_LONG();
}

// public static Android.android.widget.Toast makeText(Android.android.content.Context arg0, Android.java.lang.CharSequence arg1, int arg2) :26677
void Toast__makeText_fn(::g::Android::android::content::Context* arg0, uObject* arg1, int* arg2, Toast** __retval)
{
    *__retval = Toast::makeText(arg0, arg1, *arg2);
}

// public static extern Android.Base.Wrappers.IJWrapper makeText_IMPL_26805(Android.Base.Wrappers.IJWrapper arg0, Android.Base.Wrappers.IJWrapper arg1, int arg2) :26742
void Toast__makeText_IMPL_26805_fn(uObject* arg0_, uObject* arg1_, int* arg2_, uObject** __retval)
{
    *__retval = Toast::makeText_IMPL_26805(arg0_, arg1_, *arg2_);
}

// public void show() :26599
void Toast__show_fn(Toast* __this)
{
    __this->show();
}

// public static extern void show_IMPL_26792(bool arg0, Android.Base.Primitives.ujobject arg1) :26703
void Toast__show_IMPL_26792_fn(bool* arg0_, jobject* arg1_)
{
    Toast::show_IMPL_26792(*arg0_, *arg1_);
}

jclass Toast::_javaClass2_;
jfieldID Toast::LENGTH_LONG_26790_ID_;
jmethodID Toast::makeText_26805_ID_;
jmethodID Toast::show_26792_ID_;

// public void show() [instance] :26599
void Toast::show()
{
    Toast::show_IMPL_26792(_subclassed, _javaObject);
}

// public static extern new void _Init() [static] :26546
void Toast::_Init2()
{
    if (Toast::_javaClass2()) { return; }
    INIT_JNI;
    Toast::_javaClass2() = NEW_GLOBAL_REF(jclass,LOAD_SYS_CLASS("android/widget/Toast"));
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    if (!Toast::_javaClass2()) { THROW_UNO_EXCEPTION("Unable to cache class 'android.widget.Toast'", 44);; }
}

// public static Android.android.widget.Toast makeText(Android.android.content.Context arg0, Android.java.lang.CharSequence arg1, int arg2) [static] :26677
Toast* Toast::makeText(::g::Android::android::content::Context* arg0, uObject* arg1, int arg2)
{
    return uCast<Toast*>(Toast::makeText_IMPL_26805((uObject*)arg0, arg1, arg2), Toast_typeof());
}

// public static extern Android.Base.Wrappers.IJWrapper makeText_IMPL_26805(Android.Base.Wrappers.IJWrapper arg0, Android.Base.Wrappers.IJWrapper arg1, int arg2) [static] :26742
uObject* Toast::makeText_IMPL_26805(uObject* arg0_, uObject* arg1_, int arg2_)
{
    INIT_JNI;
    CLASS_INIT(Toast::_javaClass2(),Toast::_Init2());
    ...
    uObject* result;
    CACHE_METHOD(Toast::makeText_26805_ID(),Toast::_javaClass2(),"makeText","(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;",GetStaticMethodID,"Id for fallback method android.widget.Toast.makeText could not be cached",72);
    NEW_UNO(U_JNIVAR->CallStaticObjectMethod(Toast::_javaClass2(), Toast::makeText_26805_ID(), _obArg0, _obArg1, ((jint)arg2_)),result,Toast_typeof(),Toast*,false,true);
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    return result;
}

// public static extern void show_IMPL_26792(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :26703
void Toast::show_IMPL_26792(bool arg0_, jobject arg1_)
{
    INIT_JNI;
    CLASS_INIT(Toast::_javaClass2(),Toast::_Init2());
    
    CACHE_METHOD(Toast::show_26792_ID(),Toast::_javaClass2(),"show","()V",GetMethodID,"Id for fallback method android.widget.Toast.show could not be cached",68);
    if (arg0_) {
        U_JNIVAR->CallNonvirtualVoidMethod(arg1_, Toast::_javaClass2(), Toast::show_26792_ID());
    }
    else
    {
        U_JNIVAR->CallVoidMethod(arg1_, Toast::show_26792_ID());
    }
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
}

// public static int get_LENGTH_LONG() [static] :26568
int Toast::LENGTH_LONG()
{
    INIT_JNI;
    CLASS_INIT(Toast::_javaClass2(),Toast::_Init2());
    if (::uEnterCriticalIfNull(&Toast::LENGTH_LONG_26790_ID())) {;
    CACHE_FIELD(Toast::LENGTH_LONG_26790_ID(),Toast::_javaClass2(),"LENGTH_LONG","I",GetStaticFieldID,"Id for field Toast.LENGTH_LONG could not be cached",50);
    ::uExitCritical();;
    };
    int result;;
    result = ((int)U_JNIVAR->GetStaticIntField(Toast::_javaClass2(), Toast::LENGTH_LONG_26790_ID()));;
    return result;
}
// }
