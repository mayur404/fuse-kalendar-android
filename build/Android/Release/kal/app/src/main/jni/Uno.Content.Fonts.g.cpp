...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno
// ----------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#2
// ------------------------------------------------------------------------------

// internal sealed extern class CppFontFace :191
// {
...
// public override sealed string get_FamilyName() :225
...
// public override sealed float GetAscender(float size) :233
...
// public override sealed float GetDescender(float size) :238
...
// public override sealed float GetLineHeight(float size) :243
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(byte[] data, int offset, int length) :199
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(string filename) :193
...
// public CppFontFace New(byte[] data, int offset, int length) :212
...
// public CppFontFace New(Uno.IO.BundleFile file) :207
void CppFontFace__New2_fn(::g::Uno::IO::BundleFile* file, CppFontFace** __retval)
{
    *__retval = CppFontFace::New2(file);
}

// public override sealed Uno.Content.Fonts.RenderedGlyph RenderGlyph(float size, char glyph) :258
...
// public override sealed string get_StyleName() :230
...
// public override sealed bool TryGetKerning(float size, char left, char right, float2& result) :270
...
// public CppFontFace(byte[] data, int offset, int length) [instance] :212
...
// public CppFontFace(Uno.IO.BundleFile file) [instance] :207
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(byte[] data, int offset, int length) [static] :199
...
// private static Uno.Content.Fonts.CppFontFaceHandle LoadFontFaceHandle(string filename) [static] :193
...
// public CppFontFace New(byte[] data, int offset, int length) [static] :212
...
// public CppFontFace New(Uno.IO.BundleFile file) [static] :207
...
// internal extern struct CppFontFaceHandle :183
// {
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#3
// ------------------------------------------------------------------------------

// public sealed class DefaultTextTransform :293
// {
...
// public generated DefaultTextTransform() :293
void DefaultTextTransform__ctor_1_fn(DefaultTextTransform* __this)
{
    __this->ctor_1();
}

// public override sealed float4x4 get_Matrix() :299
...
// public override sealed void set_Matrix(float4x4 value) :300
...
// public generated DefaultTextTransform New() :293
void DefaultTextTransform__New1_fn(DefaultTextTransform** __retval)
{
    *__retval = DefaultTextTransform::New1();
}

// public override sealed float4x4 ResolveClipSpaceMatrix() :303
...
// public generated DefaultTextTransform() [instance] :293
...
// public generated DefaultTextTransform New() [static] :293
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#4
// ------------------------------------------------------------------------------

// public abstract class FontFace :324
// {
...
// protected generated FontFace() :324
void FontFace__ctor__fn(FontFace* __this)
{
    __this->ctor_();
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) :340
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) :326
void FontFace__Load1_fn(::g::Uno::IO::BundleFile* file, FontFace** __retval)
{
    *__retval = FontFace::Load1(file);
}

// protected generated FontFace() [instance] :324
void FontFace::ctor_()
{
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) [static] :340
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) [static] :326
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#5
// ------------------------------------------------------------------------------
...
// public static Uno.Content.Fonts.BitmapFont RenderSpriteFont(Uno.Content.Fonts.FontFace font, float size, string charset) :387
...
// public static Uno.Content.Fonts.BitmapFont RenderSpriteFont(Uno.Content.Fonts.FontFace font, float size, string charset) [static] :387
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#7
// ------------------------------------------------------------------------------

// public struct RenderedGlyph :520
// {
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :526
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :526
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [instance] :526
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [static] :526
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#9
// ------------------------------------------------------------------------------
...
// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :578
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#11
// -------------------------------------------------------------------------------

// public sealed class SpriteFontShader :625
// {
...
// public generated SpriteFontShader() :625
void SpriteFontShader__ctor_1_fn(SpriteFontShader* __this)
{
    __this->ctor_1();
}

// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :627
...
// private generated void init_DrawCalls() [instance] :625
...
// public generated SpriteFontShader New() [static] :625
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#12
// -------------------------------------------------------------------------------

// public sealed class TextRenderer :645
// {
...
// public TextRenderer(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) :664
...
// public float2 MeasureString(string text, int startIndex, int length) :737
...
// public TextRenderer New(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) :664
...
// public Uno.Content.Fonts.TextTransform get_Transform() :693
...
// public void set_Transform(Uno.Content.Fonts.TextTransform value) :694
void TextRenderer__set_Transform_fn(TextRenderer* __this, ::g::Uno::Content::Fonts::TextTransform* value)
{
    __this->Transform(value);
}

// private void WriteGlyph(Uno.Content.Fonts.BitmapFont.GlyphInfo ci, float2 caret) :786
...
// public void WriteString(float2 caret, string text) :781
void TextRenderer__WriteString_fn(TextRenderer* __this, ::g::Uno::Float2* caret, uString* text)
{
    __this->WriteString(*caret, text);
}

// public void WriteString(float2 caret, string text, int startIndex, int length) :828
...
// public TextRenderer(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) [instance] :664
...
// public void Begin(Uno.Content.Fonts.BitmapFont font) [instance] :721
...
// public float4 get_Color() [instance] :711
...
// public void set_Color(float4 value) [instance] :712
...
// public generated bool get_HasBegun() [instance] :647
bool TextRenderer::HasBegun()
{
    return _HasBegun;
}

// private generated void set_HasBegun(bool value) [instance] :647
void TextRenderer::HasBegun(bool value)
{
    _HasBegun = value;
}

// public float2 MeasureString(string text) [instance] :732
::g::Uno::Float2 TextRenderer::MeasureString(uString* text)
{
    return MeasureString1(text, 0, uPtr(text)->Length());
}

// public float2 MeasureString(string text, int startIndex, int length) [instance] :737
...
// public Uno.Content.Fonts.TextTransform get_Transform() [instance] :693
::g::Uno::Content::Fonts::TextTransform* TextRenderer::Transform()
{
    return _transform;
}

// public void set_Transform(Uno.Content.Fonts.TextTransform value) [instance] :694
void TextRenderer::Transform(::g::Uno::Content::Fonts::TextTransform* value)
{
    _transform = value;
}

// private void WriteGlyph(Uno.Content.Fonts.BitmapFont.GlyphInfo ci, float2 caret) [instance] :786
...
// public void WriteString(float2 caret, string text) [instance] :781
void TextRenderer::WriteString(::g::Uno::Float2 caret, uString* text)
{
    WriteString1(caret, text, 0, uPtr(text)->Length());
}

// public void WriteString(float2 caret, string text, int startIndex, int length) [instance] :828
...
// public TextRenderer New(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) [static] :664
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#13
// -------------------------------------------------------------------------------
...
// protected generated TextShader() :980
void TextShader__ctor__fn(TextShader* __this)
{
    __this->ctor_();
}

// protected generated TextShader() [instance] :980
...
// public sealed class TextShaderData :936
// {
...
// internal TextShaderData(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) :954
...
// internal TextShaderData New(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) :954
...
// internal TextShaderData(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) [instance] :954
...
// internal TextShaderData New(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) [static] :954
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Content/Fonts/$.uno#14
// -------------------------------------------------------------------------------

// public abstract class TextTransform :1012
// {
...
// protected generated TextTransform() :1012
void TextTransform__ctor__fn(TextTransform* __this)
{
    __this->ctor_();
}

// public virtual Uno.Graphics.PolygonFace get_CullFace() :1022
void TextTransform__get_CullFace_fn(TextTransform* __this, int* __retval)
{
    return *__retval = 0, void();
}

// protected generated TextTransform() [instance] :1012
