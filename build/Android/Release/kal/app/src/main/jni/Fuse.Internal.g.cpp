...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Internal/$.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Internal/$.uno#2
// ---------------------------------------------------------------
...
uClassType* FrustumMatrix_typeof()
{
    ...
    ::TYPES[2] = ::g::Uno::Float_typeof();
    ::TYPES[11] = ::g::Uno::Float4x4_typeof();
    return type;
}
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Internal/$.uno
// ------------------------------------------------------------------
...
uType* ImageContainer_typeof()
{
    ...
    ::TYPES[12] = ::g::Fuse::Resources::MemoryPolicy_typeof();
    ::TYPES[1] = ::g::Uno::Bool_typeof();
    ::TYPES[13] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof());
    ::TYPES[14] = ::g::Fuse::Resources::MultiDensityImageSource_typeof();
    ::TYPES[15] = ::g::Fuse::Resources::ImageSource_typeof();
    ::TYPES[16] = ::g::Fuse::Resources::FileImageSource_typeof();
    ::TYPES[17] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::FileSource_typeof());
    ::TYPES[18] = ::g::Uno::Delegate_typeof();
    ::TYPES[19] = ::g::Uno::EventHandler_typeof();
    ::TYPES[3] = uObject_typeof();
    ::TYPES[20] = ::g::Uno::EventArgs_typeof();
    ...
    ::TYPES[24] = ::g::Fuse::Internal::SizingContainer_typeof();
    ::TYPES[25] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof());
    ::TYPES[26] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Uno::UX::FileSource_typeof());
...
{
    if (_files == NULL)
        _files = ((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[17/*Uno.Collections.ObservableList<Uno.UX.FileSource>*/], uDelegate::New(::TYPES[25/*Uno.Action<Uno.UX.FileSource>*/], (void*)ImageContainer__OnFileAdded_fn, this), uDelegate::New(::TYPES[25/*Uno.Action<Uno.UX.FileSource>*/], (void*)ImageContainer__OnFileRemoved_fn, this)));
...
{
    ParamChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ParamChanged1, value), ::TYPES[19/*Uno.EventHandler*/]);
}
...
{
    ParamChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ParamChanged1, value), ::TYPES[19/*Uno.EventHandler*/]);
}
...
void ImageContainer::ReapplyOptions(::g::Fuse::Resources::ImageSource* src)
{
    ...
    ::g::Fuse::Resources::MultiDensityImageSource* mf = uAs< ::g::Fuse::Resources::MultiDensityImageSource*>(Source(), ::TYPES[14/*Fuse.Resources.MultiDensityImageSource*/]);

    if (mf != NULL)

        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(mf)->Sources()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[15/*Fuse.Resources.ImageSource*/]))); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::g::Uno::Collections::IEnumerator_typeof())); )
        {
            ::g::Fuse::Resources::ImageSource* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[23/*Uno.Collections.IEnumerator<Fuse.Resources.ImageSource>*/]), &ret17), ret17);
            ReapplyOptions(s);
        }
}
...
void ImageContainer::ReleaseSource()
{
    ...
    uPtr(_source)->remove_Changed(uDelegate::New(::TYPES[19/*Uno.EventHandler*/], (void*)ImageContainer__OnSourceChanged_fn, this));
...
void ImageContainer::Source(::g::Fuse::Resources::ImageSource* value)
{
    if (_source != value)
    {
        ...
        if (_source != NULL)
        {
            uPtr(_source)->add_Changed(uDelegate::New(::TYPES[19/*Uno.EventHandler*/], (void*)ImageContainer__OnSourceChanged_fn, this));
...
{
    SourceChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(SourceChanged1, value), ::TYPES[19/*Uno.EventHandler*/]);
}
...
{
    SourceChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(SourceChanged1, value), ::TYPES[19/*Uno.EventHandler*/]);
}
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Internal/$.uno#4
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Internal/$.uno#1
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Internal/$.uno#5
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Internal/$.uno#6
// ---------------------------------------------------------------
