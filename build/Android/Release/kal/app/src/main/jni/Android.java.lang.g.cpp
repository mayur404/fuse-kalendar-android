...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#93
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#28
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#48
// -----------------------------------------------------------------------
...
::g::Android::java::lang::Object_type* Integer_typeof()
{
    ...
    options.FieldCount = 9;
    options.InterfaceCount = 2;
    options.ObjectSize = sizeof(Integer);
    options.TypeSize = sizeof(::g::Android::java::lang::Object_type);
    type = (::g::Android::java::lang::Object_type*)uClassType::New("Android.java.lang.Integer", options);
    type->SetBase(::g::Android::java::lang::Object_typeof());
    type->fp_hashCode1 = (void(*)(::g::Android::java::lang::Object*, int*))Integer__hashCode1_fn;
    type->fp_toString = (void(*)(::g::Android::java::lang::Object*, ::g::Android::java::lang::String**))Integer__toString_fn;
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__UnoIDisposableDispose_fn;
    ::TYPES[2] = ::g::Android::Base::Wrappers::JWrapper_typeof();
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Android::java::lang::Object_type, interface1));
    type->SetFields(5,
        ::g::Android::Base::Primitives::ujclass_typeof(), (uintptr_t)&::g::Android::java::lang::Integer::_javaClass3_, uFieldFlagsStatic,
        ::g::Android::Base::Primitives::jmethodID_typeof(), (uintptr_t)&::g::Android::java::lang::Integer::hashCode_31132_ID_, uFieldFlagsStatic,
        ::g::Android::Base::Primitives::jmethodID_typeof(), (uintptr_t)&::g::Android::java::lang::Integer::parseInt_31135_ID_, uFieldFlagsStatic,
        ::g::Android::Base::Primitives::jmethodID_typeof(), (uintptr_t)&::g::Android::java::lang::Integer::toString_31141_ID_, uFieldFlagsStatic);
    return type;
}

// public static extern new void _Init() :11596
void Integer___Init3_fn()
{
    Integer::_Init3();
}

// public override sealed int hashCode() :11780
void Integer__hashCode1_fn(Integer* __this, int* __retval)
{
    return *__retval = Integer::hashCode_IMPL_31132(__this->_subclassed, __this->_javaObject), void();
}

// public static extern int hashCode_IMPL_31132(bool arg0, Android.Base.Primitives.ujobject arg1) :11969
void Integer__hashCode_IMPL_31132_fn(bool* arg0_, jobject* arg1_, int* __retval)
{
    *__retval = Integer::hashCode_IMPL_31132(*arg0_, *arg1_);
}

// public static int parseInt(Android.java.lang.String arg0) :11798
void Integer__parseInt_fn(::g::Android::java::lang::String* arg0, int* __retval)
{
    *__retval = Integer::parseInt(arg0);
}

// public static extern int parseInt_IMPL_31135(Android.Base.Wrappers.IJWrapper arg0) :11978
void Integer__parseInt_IMPL_31135_fn(uObject* arg0_, int* __retval)
{
    *__retval = Integer::parseInt_IMPL_31135(arg0_);
}

// public override sealed Android.java.lang.String toString() :11834
void Integer__toString_fn(Integer* __this, ::g::Android::java::lang::String** __retval)
{
    return *__retval = uCast< ::g::Android::java::lang::String*>(Integer::toString_IMPL_31141(__this->_subclassed, __this->_javaObject), ::TYPES[3/*Android.java.lang.String*/]), void();
}

// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_31141(bool arg0, Android.Base.Primitives.ujobject arg1) :11996
void Integer__toString_IMPL_31141_fn(bool* arg0_, jobject* arg1_, uObject** __retval)
{
    *__retval = Integer::toString_IMPL_31141(*arg0_, *arg1_);
}

jclass Integer::_javaClass3_;
jmethodID Integer::hashCode_31132_ID_;
jmethodID Integer::parseInt_31135_ID_;
jmethodID Integer::toString_31141_ID_;

// public static extern new void _Init() [static] :11596
void Integer::_Init3()
{
    if (Integer::_javaClass3()) { return; }
    INIT_JNI;
    Integer::_javaClass3() = NEW_GLOBAL_REF(jclass,LOAD_SYS_CLASS("java/lang/Integer"));
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    if (!Integer::_javaClass3()) { THROW_UNO_EXCEPTION("Unable to cache class 'java.lang.Integer'", 41);; }
}

// public static extern int hashCode_IMPL_31132(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :11969
int Integer::hashCode_IMPL_31132(bool arg0_, jobject arg1_)
{
    INIT_JNI;
    CLASS_INIT(Integer::_javaClass3(),Integer::_Init3());
    
    int result;
    CACHE_METHOD(Integer::hashCode_31132_ID(),Integer::_javaClass3(),"hashCode","()I",GetMethodID,"Id for fallback method java.lang.Integer.hashCode could not be cached",69);
    if (arg0_) {
        result = ((int)U_JNIVAR->CallNonvirtualIntMethod(arg1_, Integer::_javaClass3(), Integer::hashCode_31132_ID()));
    }
    else
    {
        result = ((int)U_JNIVAR->CallIntMethod(arg1_, Integer::hashCode_31132_ID()));
    }
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    return result;
}

// public static int parseInt(Android.java.lang.String arg0) [static] :11798
int Integer::parseInt(::g::Android::java::lang::String* arg0)
{
    return Integer::parseInt_IMPL_31135((uObject*)arg0);
}

// public static extern int parseInt_IMPL_31135(Android.Base.Wrappers.IJWrapper arg0) [static] :11978
int Integer::parseInt_IMPL_31135(uObject* arg0_)
{
    INIT_JNI;
    CLASS_INIT(Integer::_javaClass3(),Integer::_Init3());
    jobject _obArg0 = ((!arg0_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg0_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    int result;
    CACHE_METHOD(Integer::parseInt_31135_ID(),Integer::_javaClass3(),"parseInt","(Ljava/lang/String;)I",GetStaticMethodID,"Id for fallback method java.lang.Integer.parseInt could not be cached",69);
    result = ((int)U_JNIVAR->CallStaticIntMethod(Integer::_javaClass3(), Integer::parseInt_31135_ID(), _obArg0));
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    return result;
}

// public static extern Android.Base.Wrappers.IJWrapper toString_IMPL_31141(bool arg0, Android.Base.Primitives.ujobject arg1) [static] :11996
uObject* Integer::toString_IMPL_31141(bool arg0_, jobject arg1_)
{
    INIT_JNI;
    CLASS_INIT(Integer::_javaClass3(),Integer::_Init3());
    
    uObject* result;
    CACHE_METHOD(Integer::toString_31141_ID(),Integer::_javaClass3(),"toString","()Ljava/lang/String;",GetMethodID,"Id for fallback method java.lang.Integer.toString could not be cached",69);
    if (arg0_) {
        NEW_UNO(U_JNIVAR->CallNonvirtualObjectMethod(arg1_, Integer::_javaClass3(), Integer::toString_31141_ID()),result,::g::Android::java::lang::String_typeof(),::g::Android::java::lang::String*,false,true);
    }
    else
    {
        NEW_UNO(U_JNIVAR->CallObjectMethod(arg1_, Integer::toString_31141_ID()),result,::g::Android::java::lang::String_typeof(),::g::Android::java::lang::String*,false,true);
    }
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    return result;
}
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#90
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#89
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#72
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#76
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.27.4/Android/java/lang/$.uno#11
// -----------------------------------------------------------------------
