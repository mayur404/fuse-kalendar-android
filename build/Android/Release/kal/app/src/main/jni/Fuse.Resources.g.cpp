...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno#1
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno#3
// ---------------------------------------------------------------------

// protected enum LoadingImageSource.CleanupReason :475
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno#3
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno#6
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno#2
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno#2
// ---------------------------------------------------------------------

// public abstract class ImageSource :401
// {
...
// internal void ProxyChanged(object s, Uno.EventArgs a) :409
void ImageSource__ProxyChanged_fn(ImageSource* __this, uObject* s, ::g::Uno::EventArgs* a)
{
    __this->ProxyChanged(s, a);
}

// internal void ProxyError(object s, Fuse.Resources.ImageSourceErrorArgs a) :426
...
// public void Unpin() :439
void ImageSource__Unpin_fn(ImageSource* __this)
{
    __this->Unpin();
}

// protected generated ImageSource() [instance] :401
void ImageSource::ctor_()
{
}

// public generated void add_Changed(Uno.EventHandler value) [instance] :403
...
// public generated void remove_Changed(Uno.EventHandler value) [instance] :403
...
// public generated void add_Error(Fuse.Resources.ImageSourceErrorHandler value) [instance] :415
...
// public generated void remove_Error(Fuse.Resources.ImageSourceErrorHandler value) [instance] :415
...
// public bool get_IsPinned() [instance] :447
bool ImageSource::IsPinned()
{
    return _pinCount > 0;
}

// protected void OnChanged() [instance] :404
...
// protected void OnError(string msg, [Uno.Exception e]) [instance] :416
...
// internal void ProxyChanged(object s, Uno.EventArgs a) [instance] :409
...
// internal void ProxyError(object s, Fuse.Resources.ImageSourceErrorArgs a) [instance] :426
...
// public void Unpin() [instance] :439
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno#5
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno#4
// ----------------------------------------------------------------
...
// internal abstract class LoadingImageSource :473
// {
...
// private double Fuse.Resources.IMemoryResource.get_LastUsed() :485
...
// private Fuse.Resources.MemoryPolicy Fuse.Resources.IMemoryResource.get_MemoryPolicy() :482
...
// private void Fuse.Resources.IMemoryResource.SoftDispose() :486
void LoadingImageSource__FuseResourcesIMemoryResourceSoftDispose_fn(LoadingImageSource* __this)
{
    __this->Cleanup(2);
}

// public override sealed texture2D GetTexture() :514
...
// public override sealed int2 get_PixelSize() :628
...
// public override sealed float2 get_Size() :619
...
// protected generated LoadingImageSource() [instance] :473
...
// private void AsyncLoadTexture() [instance] :540
...
// protected void Cleanup(Fuse.Resources.LoadingImageSource.CleanupReason reason) [instance] :560
...
// protected bool get_IsLoaded() [instance] :581
bool LoadingImageSource::IsLoaded()
{
    return _texture != NULL;
}

// private void LoadTexture() [instance] :527
...
// protected void MarkUsed() [instance] :491
void LoadingImageSource::MarkUsed()
{
    _lastUsed = ::g::Fuse::Time::FrameTime();
}

// public Fuse.Resources.MemoryPolicy get_Policy() [instance] :499
::g::Fuse::Resources::MemoryPolicy* LoadingImageSource::Policy()
{
    return _policy;
}

// public void set_Policy(Fuse.Resources.MemoryPolicy value) [instance] :500
...
// public void Reload() [instance] :548
...
// protected void SetTexture(texture2D texture) [instance] :583
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno#4
// ---------------------------------------------------------------------

// public sealed class MultiDensityImageSource :662
// {
...
// private void OnImageRemoved(Fuse.Resources.ImageSource img) :688
...
// protected override sealed void OnPinChanged() :748
...
// public MultiDensityImageSource() [instance] :676
...
// private void OnImageAdded(Fuse.Resources.ImageSource img) [instance] :682
...
// private void OnImageRemoved(Fuse.Resources.ImageSource img) [instance] :688
...
// private void SelectActive() [instance] :711
...
// public Uno.Collections.IList<Fuse.Resources.ImageSource> get_Sources() [instance] :668
uObject* MultiDensityImageSource::Sources()
{
    return (uObject*)_sources;
}

// private void SwapActive(Fuse.Resources.ImageSource use) [instance] :730
...
// public MultiDensityImageSource New() [static] :676
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno#5
// ---------------------------------------------------------------------

// internal sealed class ProxyImageSource :806
// {
...
// public void Attach(Fuse.Resources.ImageSource impl) [instance] :938
...
// public void DefaultSetPolicy(Fuse.Resources.MemoryPolicy mp) [instance] :842
...
// public float get_Density() [instance] :887
...
// public void set_Density(float value) [instance] :893
...
// public texture2D GetTexture() [instance] :905
...
// public Fuse.Resources.ImageSource get_Impl() [instance] :815
::g::Fuse::Resources::ImageSource* ProxyImageSource::Impl()
{
    return _impl;
}

// public void OnPinChanged() [instance] :817
...
// public int2 get_PixelSize() [instance] :872
...
// public Fuse.Resources.MemoryPolicy get_Policy() [instance] :832
::g::Fuse::Resources::MemoryPolicy* ProxyImageSource::Policy()
{
    return _policy;
}

// public void set_Policy(Fuse.Resources.MemoryPolicy value) [instance] :833
...
// public float2 get_Size() [instance] :860
...
// public Fuse.Resources.ImageSourceState get_State() [instance] :902
int ProxyImageSource::State()
{
    return (_impl == NULL) ? 0 : uPtr(_impl)->State();
}

// private void UpdatePolicy() [instance] :851
...
// public ProxyImageSource New(Fuse.Resources.ImageSource outer) [static] :809
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Resources/$.uno#7
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/0.27.10/Resources/$.uno#6
// ---------------------------------------------------------------------

// public sealed class TextureImageSource :965
// {
...
// public override sealed float2 get_Size() :1003
...
// public override sealed float get_SizeDensity() :998
void TextureImageSource__get_SizeDensity_fn(TextureImageSource* __this, float* __retval)
{
    return *__retval = __this->Density(), void();
}

// public override sealed Fuse.Resources.ImageSourceState get_State() :1023
...
// public float get_Density() [instance] :985
float TextureImageSource::Density()
{
    return _density;
}

// public void set_Density(float value) [instance] :986
