...
// public partial sealed class MainView.Factory2.Factory4 :363
// {
// static Factory4() :370
static void MainView__Factory2__Factory4__cctor__fn(uType* __type)
{
}

::g::Uno::UX::Factory_type* MainView__Factory2__Factory4_typeof()
{
    ...
    options.ObjectSize = sizeof(MainView__Factory2__Factory4);
    options.TypeSize = sizeof(::g::Uno::UX::Factory_type);
    type = (::g::Uno::UX::Factory_type*)uClassType::New("MainView.Factory2.Factory4", options);
    type->SetBase(::g::Uno::UX::Factory_typeof());
    type->fp_cctor_ = MainView__Factory2__Factory4__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Factory*, uObject**))MainView__Factory2__Factory4__New1_fn;
    ...
    type->SetFields(2,
        ::g::MainView__Factory2_typeof(), offsetof(::g::MainView__Factory2__Factory4, __parent1), 0);
    return type;
}

// public Factory4(MainView.Factory2 parent) :366
void MainView__Factory2__Factory4__ctor_1_fn(MainView__Factory2__Factory4* __this, ::g::MainView__Factory2* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :373
void MainView__Factory2__Factory4__New1_fn(MainView__Factory2__Factory4* __this, uObject** __retval)
{
...
// public Factory4 New(MainView.Factory2 parent) :366
void MainView__Factory2__Factory4__New2_fn(::g::MainView__Factory2* parent, MainView__Factory2__Factory4** __retval)
{
    *__retval = MainView__Factory2__Factory4::New2(parent);
}

// public Factory4(MainView.Factory2 parent) [instance] :366
void MainView__Factory2__Factory4::ctor_1(::g::MainView__Factory2* parent)
{
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Factory4 New(MainView.Factory2 parent) [static] :366
MainView__Factory2__Factory4* MainView__Factory2__Factory4::New2(::g::MainView__Factory2* parent)
{
    MainView__Factory2__Factory4* obj1 = (MainView__Factory2__Factory4*)uNew(MainView__Factory2__Factory4_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
