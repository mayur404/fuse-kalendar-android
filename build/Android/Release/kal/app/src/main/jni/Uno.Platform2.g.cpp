...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Platform2/$.uno
// ------------------------------------------------------------------------
...
uClassType* Application_typeof()
{
    ...
    ::TYPES[4] = ::g::Uno::Platform::KeyEventArgs_typeof();
...
// private static void DispatchDelayedUri(Uno.Platform2.ApplicationState state) :342
...
// internal static void OnReceivedURI(string Uri) :328
...
// public static generated void add_ReceivedURI(Uno.EventHandler<string> value) :326
void Application__add_ReceivedURI_fn(uDelegate* value)
{
    Application::add_ReceivedURI(value);
}

// public static generated void remove_ReceivedURI(Uno.EventHandler<string> value) :326
...
// private static void DispatchDelayedUri(Uno.Platform2.ApplicationState state) [static] :342
...
// internal static void OnReceivedURI(string Uri) [static] :328
...
{
    Application_typeof()->Init();
    Application::KeyDown1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::KeyDown1(), value), ::TYPES[3/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    Application_typeof()->Init();
    Application::KeyDown1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::KeyDown1(), value), ::TYPES[3/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    Application_typeof()->Init();
    Application::KeyUp1() = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Application::KeyUp1(), value), ::TYPES[3/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
{
    Application_typeof()->Init();
    Application::KeyUp1() = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Application::KeyUp1(), value), ::TYPES[3/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/]);
}
...
// public static generated void add_ReceivedURI(Uno.EventHandler<string> value) [static] :326
...
// public static generated void remove_ReceivedURI(Uno.EventHandler<string> value) [static] :326
...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Source/Uno/Platform2/$.uno#1
// --------------------------------------------------------------------------

// public sealed extern class Display :364
// {
//  ~Display() :375
...
// private generated void add__tick(Uno.EventHandler<Uno.Platform.TimerEventArgs> value) [instance] :439
...
// private generated void remove__tick(Uno.EventHandler<Uno.Platform.TimerEventArgs> value) [instance] :439
...
// public generated float get_Density() [instance] :390
float Display::Density()
{
    return _Density;
}

// private generated void set_Density(float value) [instance] :390
void Display::Density(float value)
{
    _Density = value;
}

// private extern void Destroy() [instance] :381
void Display::Destroy()
{
    this->_private.Destroy(this);
}

// public Uno.Rect get_Frame() [instance] :395
::g::Uno::Rect Display::Frame()
{
    return _frame;
}

// private void set_Frame(Uno.Rect value) [instance] :396
...
// public generated void add_FrameChanged(Uno.EventHandler value) [instance] :406
...
// public generated void remove_FrameChanged(Uno.EventHandler value) [instance] :406
...
// public uint get_FramesPerSecond() [instance] :421
uint32_t Display::FramesPerSecond()
{
    return _framesPerSecond;
}

// public void set_FramesPerSecond(uint value) [instance] :422
...
// private extern void Initialize() [instance] :380
void Display::Initialize()
{
    this->_private.Initialize(this);
}

// private void OnFrameChanged() [instance] :407
...
// private void OnTick(Uno.Platform.TimerEventArgs args) [instance] :461
...
// private extern void SetFramesPerSecond(uint value) [instance] :433
void Display::SetFramesPerSecond(uint32_t value_)
{
    this->_private.SetFramesPerSecond(this, value_);
}

// private static extern Uno.Platform2.Display GetMainDisplay() [static] :384
...
// private Display New() [static] :369
...
// public static Uno.Platform2.Display get_MainDisplay() [static] :383
...
// private struct Display.PrivateState :366
// {
