...
// /usr/local/share/uno/Packages/UnoCore/0.27.15/Targets/Android/Uno/Base/$.uno#4
// ------------------------------------------------------------------------------
...
// public static extern byte[] JavaToUnoByteArray(Android.Base.Primitives.ujobject arr, long len) :2529
void Arrays__JavaToUnoByteArray_fn(jobject* arr_, int64_t* len_, uArray** __retval)
{
    *__retval = Arrays::JavaToUnoByteArray(*arr_, *len_);
}

// public static extern byte[] JavaToUnoByteArray(Android.Base.Primitives.ujobject arr, long len) [static] :2529
