...
// public partial sealed class MainView.Factory8.Factory10 :1165
// {
// static Factory10() :1172
static void MainView__Factory8__Factory10__cctor__fn(uType* __type)
{
}

::g::Uno::UX::Factory_type* MainView__Factory8__Factory10_typeof()
{
    ...
    options.ObjectSize = sizeof(MainView__Factory8__Factory10);
    options.TypeSize = sizeof(::g::Uno::UX::Factory_type);
    type = (::g::Uno::UX::Factory_type*)uClassType::New("MainView.Factory8.Factory10", options);
    type->SetBase(::g::Uno::UX::Factory_typeof());
    type->fp_cctor_ = MainView__Factory8__Factory10__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Factory*, uObject**))MainView__Factory8__Factory10__New1_fn;
    ...
    type->SetFields(2,
        ::g::MainView__Factory8_typeof(), offsetof(::g::MainView__Factory8__Factory10, __parent1), 0);
    return type;
}

// public Factory10(MainView.Factory8 parent) :1168
void MainView__Factory8__Factory10__ctor_1_fn(MainView__Factory8__Factory10* __this, ::g::MainView__Factory8* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :1175
void MainView__Factory8__Factory10__New1_fn(MainView__Factory8__Factory10* __this, uObject** __retval)
{
...
// public Factory10 New(MainView.Factory8 parent) :1168
void MainView__Factory8__Factory10__New2_fn(::g::MainView__Factory8* parent, MainView__Factory8__Factory10** __retval)
{
    *__retval = MainView__Factory8__Factory10::New2(parent);
}

// public Factory10(MainView.Factory8 parent) [instance] :1168
void MainView__Factory8__Factory10::ctor_1(::g::MainView__Factory8* parent)
{
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Factory10 New(MainView.Factory8 parent) [static] :1168
MainView__Factory8__Factory10* MainView__Factory8__Factory10::New2(::g::MainView__Factory8* parent)
{
    MainView__Factory8__Factory10* obj1 = (MainView__Factory8__Factory10*)uNew(MainView__Factory8__Factory10_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
