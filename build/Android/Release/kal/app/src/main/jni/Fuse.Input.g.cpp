...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#7
// ------------------------------------------------------------
...
{
    return uPtr(Node())->IsContextEnabled() && uPtr(Node())->IsRooted();
}
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#6
// ------------------------------------------------------------
...
Pointer__DefaultPointerEventResponder_type* Pointer__DefaultPointerEventResponder_typeof()
{
    ...
    ::TYPES[3] = ::g::Fuse::Input::Pointer_typeof();
    ::TYPES[2] = ::g::Fuse::Input::PointerEventArgs_typeof();
    ::TYPES[4] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Input::Pointer__PointerRecord_typeof());
    ::TYPES[5] = ::g::Fuse::Input::Pointer__PointerRecord_typeof();
    ::TYPES[6] = ::g::Fuse::NodeEventArgs_typeof();
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#2
// ------------------------------------------------------------
...
{
    Focus_typeof()->Init();
    return (node == NULL) || ((uPtr(node)->IsRooted() && uPtr(node)->IsContextEnabled()) && Focus::IsFocusable(node));
}
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#1
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#3
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#4
// ------------------------------------------------------------
...
static void Pointer__cctor__fn(uType* __type)
{
    ...
    Pointer::_pointersDown_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[4/*Uno.Collections.Dictionary<int, Fuse.Input.Pointer.PointerRecord>*/]));
...
uClassType* Pointer_typeof()
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof());
...
bool Pointer::HardCapture(int pointIndex, ::g::Fuse::Node* node, uObject* identity, uDelegate* lostCallback)
{
    ...
    if (!uPtr(node)->IsContextEnabled() || !uPtr(node)->IsRooted())
        return false;
...
bool Pointer::SoftCapture(int pointIndex, ::g::Fuse::Node* softCapturer, uObject* identity, uDelegate* lostCallback)
{
    ...
    if (!uPtr(softCapturer)->IsContextEnabled() || !uPtr(softCapturer)->IsRooted())
        return false;
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#5
// ------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::g::Fuse::Scripting::IEventSerializer_typeof()), ::STRINGS[14/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::g::Fuse::Scripting::IEventSerializer_typeof()), ::STRINGS[15/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::g::Fuse::Scripting::IEventSerializer_typeof()), ::STRINGS[16/*"index"*/], __this->PointIndex());
}
...
// /usr/local/share/uno/Packages/FuseCore/0.27.10/Input/$.uno#8
// ------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::g::Fuse::Scripting::IEventSerializer_typeof()), ::STRINGS[17/*"text"*/], __this->Text());
}
