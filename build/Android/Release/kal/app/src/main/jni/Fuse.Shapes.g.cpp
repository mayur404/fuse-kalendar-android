...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno
// -------------------------------------------------------
...
::g::Fuse::Shapes::Shape_type* Circle_typeof()
{
    ...
    type->SetInterfaces(
        ::g::Fuse::IChildObject_typeof(), offsetof(::g::Fuse::Shapes::Shape_type, interface0),
...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno#1
// ---------------------------------------------------------
...
::g::Fuse::Shapes::PathShape_type* Ellipse_typeof()
{
    ...
    type->SetInterfaces(
        ::g::Fuse::IChildObject_typeof(), offsetof(::g::Fuse::Shapes::PathShape_type, interface0),
...
void Ellipse__UpdatePath_fn(Ellipse* __this)
{
    ...
    if (::g::Uno::Float2__op_Equality(__this->_cachedRadius, radius))
        return;
...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno#2
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno#5
// ---------------------------------------------------------
...
PathShape_type* PathShape_typeof()
{
    ...
    type->SetInterfaces(
        ::g::Fuse::IChildObject_typeof(), offsetof(PathShape_type, interface0),
...
void PathShape__OnRooted_fn(PathShape* __this)
{
    ...
    uPtr(__this->_renderer)->Density(::g::Fuse::IViewport::PixelsPerPoint(uInterface(uPtr(__this->Viewport()), ::TYPES[16/*Fuse.IViewport*/])));
}
...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno#3
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno#4
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Shapes/0.27.10/$.uno#6
// ---------------------------------------------------------
