...
// public partial sealed class MainView.Factory.Factory2 :46
// {
// static Factory2() :53
static void MainView__Factory__Factory2__cctor__fn(uType* __type)
{
}

::g::Uno::UX::Factory_type* MainView__Factory__Factory2_typeof()
{
    ...
    options.ObjectSize = sizeof(MainView__Factory__Factory2);
    options.TypeSize = sizeof(::g::Uno::UX::Factory_type);
    type = (::g::Uno::UX::Factory_type*)uClassType::New("MainView.Factory.Factory2", options);
    type->SetBase(::g::Uno::UX::Factory_typeof());
    type->fp_cctor_ = MainView__Factory__Factory2__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Factory*, uObject**))MainView__Factory__Factory2__New1_fn;
    ::STRINGS[0] = uString::Const("MOVIE");
    ...
    type->SetFields(2,
        ::g::MainView__Factory_typeof(), offsetof(::g::MainView__Factory__Factory2, __parent1), 0);
    return type;
}

// public Factory2(MainView.Factory parent) :49
void MainView__Factory__Factory2__ctor_1_fn(MainView__Factory__Factory2* __this, ::g::MainView__Factory* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :56
void MainView__Factory__Factory2__New1_fn(MainView__Factory__Factory2* __this, uObject** __retval)
{
...
// public Factory2 New(MainView.Factory parent) :49
void MainView__Factory__Factory2__New2_fn(::g::MainView__Factory* parent, MainView__Factory__Factory2** __retval)
{
    *__retval = MainView__Factory__Factory2::New2(parent);
}

// public Factory2(MainView.Factory parent) [instance] :49
void MainView__Factory__Factory2::ctor_1(::g::MainView__Factory* parent)
{
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Factory2 New(MainView.Factory parent) [static] :49
MainView__Factory__Factory2* MainView__Factory__Factory2::New2(::g::MainView__Factory* parent)
{
    MainView__Factory__Factory2* obj1 = (MainView__Factory__Factory2*)uNew(MainView__Factory__Factory2_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
