...
// public partial sealed class MainView.Factory14 :1770
// {
// static Factory14() :1780
static void MainView__Factory14__cctor__fn(uType* __type)
{
}

::g::Uno::UX::Factory_type* MainView__Factory14_typeof()
{
    ...
    options.ObjectSize = sizeof(MainView__Factory14);
    options.TypeSize = sizeof(::g::Uno::UX::Factory_type);
    type = (::g::Uno::UX::Factory_type*)uClassType::New("MainView.Factory14", options);
    type->SetBase(::g::Uno::UX::Factory_typeof());
    type->fp_cctor_ = MainView__Factory14__cctor__fn;
    type->fp_New1 = (void(*)(::g::Uno::UX::Factory*, uObject**))MainView__Factory14__New1_fn;
    ::STRINGS[0] = uString::Const("title");
    ::STRINGS[1] = uString::Const("date");
    ::STRINGS[2] = uString::Const("countryListClicked");
    ...
    type->SetFields(2,
        ::g::MainView_typeof(), offsetof(::g::MainView__Factory14, __parent1), 0,
        ::g::kal_FuseControlsPanel_Background_Property_typeof(), offsetof(::g::MainView__Factory14, self_Background_inst), 0,
        ::g::kal_FuseControlsText_Value_Property_typeof(), offsetof(::g::MainView__Factory14, temp_Value_inst), 0,
        ::g::kal_FuseControlsText_Value_Property_typeof(), offsetof(::g::MainView__Factory14, temp1_Value_inst), 0);
    return type;
}

// public Factory14(MainView parent) :1773
void MainView__Factory14__ctor_1_fn(MainView__Factory14* __this, ::g::MainView* parent)
{
    __this->ctor_1(parent);
}

// public override sealed object New() :1783
void MainView__Factory14__New1_fn(MainView__Factory14* __this, uObject** __retval)
{
    ...
    self->Name(::STRINGS[2/*"countryList...*/]);
    temp->FontSize(15.0f);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Behaviors()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[8/*Fuse.Behavior*/])), temp2);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Behaviors()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[8/*Fuse.Behavior*/])), temp3);
    temp4->Width(::g::Uno::UX::Size__New1(100.0f, 3));
    temp4->Height(::g::Uno::UX::Size__New1(1.0f, 0));
    temp4->Alignment(12);
    temp4->Background(temp5);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp6->Animators()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[12/*Fuse.Animations.Animator*/])), temp7);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(self->Behaviors()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[8/*Fuse.Behavior*/])), temp6);
    return *__retval = self, void();
}

// public Factory14 New(MainView parent) :1773
void MainView__Factory14__New2_fn(::g::MainView* parent, MainView__Factory14** __retval)
{
    *__retval = MainView__Factory14::New2(parent);
}

// public Factory14(MainView parent) [instance] :1773
void MainView__Factory14::ctor_1(::g::MainView* parent)
{
    ctor_(NULL, false);
    __parent1 = parent;
}

// public Factory14 New(MainView parent) [static] :1773
MainView__Factory14* MainView__Factory14::New2(::g::MainView* parent)
{
    MainView__Factory14* obj1 = (MainView__Factory14*)uNew(MainView__Factory14_typeof());
    obj1->ctor_1(parent);
    return obj1;
}
// }
