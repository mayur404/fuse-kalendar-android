...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.10/Internal/$.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.10/Internal/$.uno#1
// --------------------------------------------------------------------
...
uClassType* RectExtensions_typeof()
{
    ...
    type = uClassType::New("Fuse.Controls.Internal.RectExtensions", options);
    ::TYPES[12] = ::g::Uno::Rect_typeof();
    ::TYPES[13] = ::g::Uno::Float2_typeof();
    return type;
}
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.10/Internal/$.uno#2
// --------------------------------------------------------------------
...
uType* WordWrapInfo_typeof()
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Float_typeof(), offsetof(::g::Fuse::Controls::Internal::WordWrapInfo, LineSpacing), 0,
...
// public WordWrapInfo(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) :291
...
// public override sealed bool Equals(object obj) :303
...
// public override sealed int GetHashCode() :319
...
// public WordWrapInfo New(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) :291
...
// public WordWrapInfo(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) [instance] :291
...
// public WordWrapInfo New(Fuse.Controls.Internal.DefaultTextRenderer textRenderer, bool isEnabled, float wrapWidth, float fontSize, float lineHeight, float lineSpacing, float absoluteZoom) [static] :291
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.10/Internal/$.uno#3
// --------------------------------------------------------------------
...
uClassType* WordWrapper_typeof()
{
    ...
    ::TYPES[14] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Internal::WordWrapperWord_typeof());
    ::TYPES[15] = ::g::Uno::String_typeof();
    ::TYPES[8] = ::g::Uno::Bool_typeof();
    ::TYPES[13] = ::g::Uno::Float2_typeof();
    ::TYPES[16] = ::g::Fuse::Controls::Internal::WordWrapInfo_typeof();
    ::TYPES[17] = ::g::Fuse::Controls::Internal::WordWrapperWord_typeof();
    ::TYPES[9] = ::g::Uno::Float_typeof();
    ::TYPES[18] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Internal::WrappedLine_typeof());
    return type;
}

// private static Uno.Collections.List<Fuse.Controls.Internal.WordWrapperWord> GetWords(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) :404
...
// private static Fuse.Controls.Internal.WordWrapperWord SplitWord(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Uno.Collections.List<Fuse.Controls.Internal.WrappedLine> wrappedLines, Fuse.Controls.Internal.WordWrapperWord word, int& lineStartIndex) :431
...
// public static Fuse.Controls.Internal.WrappedLine[] WrapLine(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) :365
...
// private static Uno.Collections.List<Fuse.Controls.Internal.WordWrapperWord> GetWords(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) [static] :404
::g::Uno::Collections::List* WordWrapper::GetWords(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, uString* text)
{
    ::g::Uno::Collections::List* ret = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[14/*Uno.Collections.List<Fuse.Controls.Internal.WordWrapperWord>*/]);
...
// private static Fuse.Controls.Internal.WordWrapperWord SplitWord(Fuse.Controls.Internal.WordWrapInfo wrapInfo, Uno.Collections.List<Fuse.Controls.Internal.WrappedLine> wrappedLines, Fuse.Controls.Internal.WordWrapperWord word, int& lineStartIndex) [static] :431
...
// public static Fuse.Controls.Internal.WrappedLine[] WrapLine(Fuse.Controls.Internal.WordWrapInfo wrapInfo, string text) [static] :365
uArray* WordWrapper::WrapLine(::g::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, uString* text)
{
    ...
    ::g::Uno::Collections::List* ret = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[18/*Uno.Collections.List<Fuse.Controls.Internal.WrappedLine>*/]);
...
// public WordWrapperWord(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) :352
...
// public WordWrapperWord New(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) :352
...
// public WordWrapperWord(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) [instance] :352
...
// public WordWrapperWord New(string contents, string whitespace, int startIndex, float contentsWidth, float totalContentsWidth) [static] :352
...
// /usr/local/share/uno/Packages/Fuse.Controls/0.27.10/Internal/$.uno#4
// --------------------------------------------------------------------
...
// public WrappedLine(string text, int lineTextStartOffset, float yOffset, float lineWidth) :479
...
// public float GetXOffset(Fuse.Elements.TextAlignment textAlignment, float boundsWidth, float absoluteZoom) :487
...
// public int get_LineTextEndOffset() :477
void WrappedLine__get_LineTextEndOffset_fn(WrappedLine* __this, int* __retval)
{
    *__retval = __this->LineTextEndOffset();
}

// public WrappedLine New(string text, int lineTextStartOffset, float yOffset, float lineWidth) :479
...
// public float PosToBounds(Fuse.Controls.Internal.WordWrapInfo wrapInfo, int p) :530
...
// public WrappedLine(string text, int lineTextStartOffset, float yOffset, float lineWidth) [instance] :479
...
// public float GetXOffset(Fuse.Elements.TextAlignment textAlignment, float boundsWidth, float absoluteZoom) [instance] :487
...
// public int get_LineTextEndOffset() [instance] :477
int WrappedLine::LineTextEndOffset()
{
    return LineTextStartOffset + uPtr(Text)->Length();
}

// public float PosToBounds(Fuse.Controls.Internal.WordWrapInfo wrapInfo, int p) [instance] :530
...
// public WrappedLine New(string text, int lineTextStartOffset, float yOffset, float lineWidth) [static] :479
