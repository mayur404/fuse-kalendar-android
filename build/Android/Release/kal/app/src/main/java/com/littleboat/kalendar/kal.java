...
public class kal extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
{
    ...
    {
    	kal activity = _appState.CurrentActivity;
...
//        if (intent!=null && intent.getScheme() == "#(Project.Mobile.UriScheme)")
//        {
