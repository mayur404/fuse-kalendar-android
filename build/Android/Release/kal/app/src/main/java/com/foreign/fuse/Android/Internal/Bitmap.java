...
public class Bitmap
{
    ...
    public static Object CreateBitmapARGB8888Impl56(final int width,final int height)
    {
        return android.graphics.Bitmap.createBitmap(width, height, android.graphics.Bitmap.Config.ARGB_8888);
    }
    
    public static void EraseColor157(final Object handle,final int color)
    {
        ((android.graphics.Bitmap)handle).eraseColor(color);
    }
    
    public static void Recycle158(final Object handle)
    {
