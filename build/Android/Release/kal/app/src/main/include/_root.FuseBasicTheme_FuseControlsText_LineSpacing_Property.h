...
struct FuseBasicTheme_FuseControlsText_LineSpacing_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Controls::Text*> _obj;

    void ctor_1(::g::Fuse::Controls::Text* obj);
    static FuseBasicTheme_FuseControlsText_LineSpacing_Property* New1(::g::Fuse::Controls::Text* obj);
};
// }
