// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Android/0.27.10/$.uno#4'.
...
struct InputDispatch : uObject
{
    ...
    static void ReleaseHardCapture(::g::Fuse::Node* node, ::g::Fuse::Input::PointerEventData* data);
