// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Video/0.27.10/Android/$.uno'.
...
namespace g{namespace Fuse{namespace Video{namespace Graphics{namespace Android{struct MediaPlayer;}}}}}
namespace g{namespace Fuse{namespace Video{namespace Graphics{namespace Android{struct VideoLoader__VideoPromise;}}}}}
...
struct VideoLoader__VideoPromise : ::g::Uno::Threading::Promise
{
    ...
    uStrong< ::g::Fuse::Video::Graphics::Android::MediaPlayer*> _videoPlayer;
