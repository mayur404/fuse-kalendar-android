...
struct FuseBasicTheme_FuseControlsRectangle_Height_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Controls::Rectangle*> _obj;

    void ctor_1(::g::Fuse::Controls::Rectangle* obj);
    static FuseBasicTheme_FuseControlsRectangle_Height_Property* New1(::g::Fuse::Controls::Rectangle* obj);
};
// }
