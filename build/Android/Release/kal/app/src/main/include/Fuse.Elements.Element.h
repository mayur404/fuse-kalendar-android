// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Elements/0.27.10/$.uno'.
...
struct Element : ::g::Fuse::Node
{
    ...
    static uSStrong< ::g::Fuse::StyleProperty1*> AnchorProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& AnchorProperty() { return Element_typeof()->Init(), AnchorProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> AspectConstraintProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& AspectConstraintProperty() { return Element_typeof()->Init(), AspectConstraintProperty_; }
    ...
    static uSStrong< ::g::Fuse::StyleProperty1*> HeightProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& HeightProperty() { return Element_typeof()->Init(), HeightProperty_; }
    ...
    static uSStrong< ::g::Fuse::StyleProperty1*> LimitHeightProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& LimitHeightProperty() { return Element_typeof()->Init(), LimitHeightProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> LimitWidthProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& LimitWidthProperty() { return Element_typeof()->Init(), LimitWidthProperty_; }
    ...
    static uSStrong< ::g::Fuse::StyleProperty1*> MaxHeightProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& MaxHeightProperty() { return Element_typeof()->Init(), MaxHeightProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> MaxWidthProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& MaxWidthProperty() { return Element_typeof()->Init(), MaxWidthProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> MinHeightProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& MinHeightProperty() { return Element_typeof()->Init(), MinHeightProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> MinWidthProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& MinWidthProperty() { return Element_typeof()->Init(), MinWidthProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> OffsetProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& OffsetProperty() { return Element_typeof()->Init(), OffsetProperty_; }
    ...
    static uSStrong< ::g::Fuse::Scripting::ScriptClass*> ScriptClass1_;
    static uSStrong< ::g::Fuse::Scripting::ScriptClass*>& ScriptClass1() { return Element_typeof()->Init(), ScriptClass1_; }
    ...
    static uSStrong< ::g::Fuse::StyleProperty1*> WidthProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& WidthProperty() { return Element_typeof()->Init(), WidthProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> XProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& XProperty() { return Element_typeof()->Init(), XProperty_; }
    static uSStrong< ::g::Fuse::StyleProperty1*> YProperty_;
    static uSStrong< ::g::Fuse::StyleProperty1*>& YProperty() { return Element_typeof()->Init(), YProperty_; }
    ...
    static void collapse(Element* e, uArray* args);
    ...
    static bool GetClipToBounds(Element* elm);
    static ::g::Uno::Float2 GetContentSize(Element* __this, ::g::Fuse::LayoutParams lp);
    static ::g::Uno::UX::Size GetHeight(Element* elm);
    static uObject* GetTransformOrigin(Element* elm);
    static int GetVisibility(Element* elm);
    static ::g::Uno::UX::Size GetWidth(Element* elm);
    static void hide(Element* e, uArray* args);
    ...
    static void SetClipToBounds(Element* elm, bool value);
    static void SetHeight(Element* elm, ::g::Uno::UX::Size val);
    static void SetTransformOrigin(Element* elm, uObject* value);
    static void SetVisibility(Element* elm, int value);
    static void SetWidth(Element* elm, ::g::Uno::UX::Size val);
    static void show(Element* e, uArray* args);
