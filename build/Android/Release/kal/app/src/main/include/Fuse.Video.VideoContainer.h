// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Video/0.27.10/$.uno#2'.
...
struct VideoContainer : uObject
{
    ...
    static float& CompletionTimeThreshold() { return VideoContainer_typeof()->Init(), CompletionTimeThreshold_; }
    ...
    void OnLoaded(uObject* videoPlayer);
    void OnLoading();
