// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Android/0.27.10/NativeViews/$.uno#3'.
...
struct NativeView_type : ::g::Fuse::Behavior_type
{
    ...
    void(*fp_set_Visible)(::g::Fuse::Android::NativeViews::NativeView*, bool*);
};
...
struct NativeView : ::g::Fuse::Behavior
{
    ...
    void Visible(bool value) { (((NativeView_type*)__type)->fp_set_Visible)(this, &value); }
    ...
    static void Visible(NativeView* __this, bool value) { NativeView__set_Visible_fn(__this, &value); }
};
