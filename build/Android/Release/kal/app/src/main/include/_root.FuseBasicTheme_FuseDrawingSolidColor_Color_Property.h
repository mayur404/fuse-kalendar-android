...
struct FuseBasicTheme_FuseDrawingSolidColor_Color_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Drawing::SolidColor*> _obj;

    void ctor_1(::g::Fuse::Drawing::SolidColor* obj);
    static FuseBasicTheme_FuseDrawingSolidColor_Color_Property* New1(::g::Fuse::Drawing::SolidColor* obj);
};
// }
