// This file was generated based on '/usr/local/share/uno/Packages/FuseCore/0.27.10/$.uno#7'.
...
struct NodeEvent : uObject
{
    ...
    template<class THandler>
    void InvokeInternal(THandler handler, uObject* sender, ::g::Fuse::NodeEventArgs* args) { NodeEvent__InvokeInternal_fn(this, uConstrain(__type->GetBase(NodeEvent_typeof())->T(0), handler), sender, args); }
