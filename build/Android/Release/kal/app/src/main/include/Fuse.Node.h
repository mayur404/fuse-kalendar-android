// This file was generated based on '/usr/local/share/uno/Packages/FuseCore/0.27.10/$.uno#19'.
...
{
    ::g::Fuse::IChildObject interface0;
    ...
    void(*fp_OnInvalidateChildZOffset)(::g::Fuse::Node*, ::g::Fuse::Node*);
    void(*fp_OnInvalidateLayout)(::g::Fuse::Node*);
    void(*fp_OnInvalidateRenderBounds)(::g::Fuse::Node*, bool*);
    void(*fp_OnInvalidateVisual)(::g::Fuse::Node*);
...
struct Node : uObject
{
    ...
    bool _isContextEnabledCache;
    static uSStrong< ::g::Fuse::PropertyHandle*> _isContextEnabledChangedHandle_;
    static uSStrong< ::g::Fuse::PropertyHandle*>& _isContextEnabledChangedHandle() { return Node_typeof()->Init(), _isContextEnabledChangedHandle_; }
    bool _isFlat;
    bool _isFlatCached;
    ...
    uStrong<Node*> OverrideContextParent;
    static uSStrong< ::g::Fuse::Scripting::ScriptClass*> ScriptClass_;
    static uSStrong< ::g::Fuse::Scripting::ScriptClass*>& ScriptClass() { return Node_typeof()->Init(), ScriptClass_; }
    ...
    int DistanceTo(uObject* obj, int reference);
    ...
    bool IsNode(uObject* obj);
    bool IsRooted();
    bool IsRootStage(int stage);
    bool IsSubtreeRooted();
    bool IsVisible();
    ...
    void OnInvalidateChildZOffset(Node* child) { (((Node_type*)__type)->fp_OnInvalidateChildZOffset)(this, child); }
    ...
    void OnInvalidateVisual() { (((Node_type*)__type)->fp_OnInvalidateVisual)(this); }
    ...
    static void bringIntoView(Node* n, uArray* args);
    static void disable(Node* n, uArray* args);
    ...
    static void OnInvalidateChildZOffset(Node* __this, Node* child) { Node__OnInvalidateChildZOffset_fn(__this, child); }
    ...
    static void OnInvalidateVisual(Node* __this) { Node__OnInvalidateVisual_fn(__this); }
    ...
    static void SetName(Node* n, uString* v);
