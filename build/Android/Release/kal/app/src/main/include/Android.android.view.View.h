// This file was generated based on '/usr/local/share/uno/Packages/Android/0.27.4/Android/android/view/$.uno#8'.
...
struct View_type : ::g::Android::java::lang::Object_type
{
    ...
    void(*fp_invalidate)(::g::Android::android::view::View*);
...
struct View : ::g::Android::java::lang::Object
{
    ...
    void invalidate() { (((View_type*)__type)->fp_invalidate)(this); }
    ...
    static void invalidate(View* __this) { View__invalidate_fn(__this); }
