// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Android/0.27.10/Internal/$.uno#3'.
...
struct StaticLayout : uObject
{
    ...
    void ctor_1(uString* text, ::g::Fuse::Android::Internal::TextPaint* paint, int width, int align, float spacingMult, float spacingAdd, bool includePad);
    void ctor_2(uString* text, int bufStart, int bufEnd, ::g::Fuse::Android::Internal::TextPaint* paint, int outerWidth, int align, float spacingMult, float spacingAdd, bool includePad, int truncateAt, int ellipsizedWith);
    void Draw(::g::Fuse::Android::Internal::Canvas* canvas);
    int EllipsizedWidth();
    ...
    static float GetDesiredWidth(uString* text, ::g::Fuse::Android::Internal::TextPaint* paint);
    ...
    static StaticLayout* New2(uString* text, ::g::Fuse::Android::Internal::TextPaint* paint, int width, int align, float spacingMult, float spacingAdd, bool includePad);
    static StaticLayout* New3(uString* text, int bufStart, int bufEnd, ::g::Fuse::Android::Internal::TextPaint* paint, int outerWidth, int align, float spacingMult, float spacingAdd, bool includePad, int truncateAt, int ellipsizedWith);
};
// }
