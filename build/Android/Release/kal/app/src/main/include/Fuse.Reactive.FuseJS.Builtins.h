// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Reactive/0.27.10/FuseJS/$.uno'.
...
struct Builtins : uObject
{
    ...
    static uSStrong< ::g::Fuse::Reactive::FuseJS::TimerModule*>& _timer() { return Builtins_typeof()->Init(), _timer_; }
    ...
    static void Register(uString* moduleId, ::g::Fuse::Scripting::NativeModule* module);
};
// }
