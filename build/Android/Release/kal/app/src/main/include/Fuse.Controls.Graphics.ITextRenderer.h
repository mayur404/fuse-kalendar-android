// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.27.10/Graphics/$.uno#3'.
...
struct ITextRenderer
{
    ...
    void(*fp_Draw)(uObject*, ::g::Fuse::DrawContext*, ::g::Fuse::Node*);
    ...
    static void Draw(const uInterface& __this, ::g::Fuse::DrawContext* dc, ::g::Fuse::Node* where) { __this.VTable<ITextRenderer>()->fp_Draw(__this, dc, where); }
